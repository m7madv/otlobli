...
- أبل قبلت الاسم الإنجليزي المعتمد (AppInfoLocalization `526e8298-b99d-4392-aa2a-9402cff3a07e`) في تشغيل34040159491؛ أنشأت صفحة اللغة تلقائيًا فأوقف تكرار الإنشاء التشغيل. عُدّل السكربت ليعيد قراءة اللغات ويستأنف دون تكرار. الرفع الموقّع21 جارٍ في34040157335؛ لا تأكيد رفع/نشر بعد.
...
- 0.1.2(21) لم ينشر أو يرفع بعد في هذه اللحظة. حدّث مسار TestFlight إلى21 مع تحقق11لغة أصلية ومنع التشغيل التلقائي عند الدفع؛ الرفع بتشغيل صريح واحد. workflow الصور لا يقدم مراجعة أو يختار بناء أو يغيّر البلدان. Google ما زال مثبتًا على20. لغة المتجر الأساسية ومعرفات التطبيق وملكيته والاشتراكات واستثناء فرنسا لا تتغير؛ تعديل الاسم ليس ضمانًا لحقوق علامة تجارية.
