...
الفحص34040072308 أكد Build32 VALID بالمعرّف7848f16a-97f9-4315-93bd-daea14024fc2 ووجوده ضمن Damanak Internal؛ لا تغيير للمختبرين. أضيفت نسخة متجر إنجليزية بريطانية en-GB قيد الرفع لأن متاجر الخليج تعتمدها افتراضياً حسب توثيق Apple؛ يصبح الهدف11 محلية متجر/110 صور مع بقاء10 لغات داخل التطبيق. لا تغيير للحزمة.
...
Apple: المنشور يبقى4.5.0؛ مسودة4.6.0 هي `af5f3581-d237-476d-b8c4-a42c73f7cc19` PREPARE_FOR_SUBMISSION. حُفظت أوصاف اللغات العشر في run34039402544 ورُفعت100 صورة بحالة COMPLETE مع تطابق SHA-256. iOS run34039342937 نجح وApple أكدت الرفع؛ IPA حجمه24965730 وبصمتهE4728DFE2289CEC91FD9449AB057A514593F682BE1815B543F2F2DEF6CBBA1A7. الفحص الفوري34039915098 ما يزال يرى31 كأحدث بناء؛ لا تعتبر32 VALID أو متاحاً بعد. التقرير `damanak_flutter/docs/LOCALIZATION_RELEASE_2026-09-06.md` يحفظ التفاصيل.
