...
- نجح التحقق المحلي للبناء 10: `dart format --set-exit-if-changed .` على 70 ملفاً، و`flutter analyze --no-pub` بلا مشكلات، و30 اختباراً غير golden، و11 golden، و`flutter build apk --debug`. APK في `voicebrief_flutter/build/app/outputs/flutter-apk/app-debug.apk`، حجمه `177,592,197` بايت وبصمته SHA-256 `3C9B96B65281D140CAF3FEA05DAEBFB6CD636A7E78BD1ABB5803E7A548F97C15`. تحقق Xcode والتوقيع وظهور خيار فتح الصوت على iPhone ينتظران CI والبناء الموقع ثم قبول الجهاز.
...
- البناء 9 يبقى آخر نسخة TestFlight متاحة حتى اكتمال رفع البناء 10. تحذير الرفع الوحيد هو أن Apple ستطلب iOS 15 للبناءات المرفوعة بدءاً من ربيع 2027. بعد وصول البناء 10 يجب التحقق على iPhone من ظهور خيار VoiceBrief الذي يفتح الملف مباشرة، ومن التشغيل البارد والدافئ والاستيراد، ولا يجوز ادعاء قبوله قبل ذلك.
