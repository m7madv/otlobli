...
## VoiceBrief — الترويج المجاني والفهرسة، 19 سبتمبر 2026

طلب المالك الترويج المجاني للنسخة المنشورة على الآيفون. أكد جلب صفحة أبل العامة الاسم `VoiceBrief: Audio Summaries` ومعرّف 6805194629 والناشر `mohammad alzouabi` والإصدار 0.1.2 ولغات الواجهة الـ11. وجدنا أن جذر الموقع كان يحوّل إلى الخصوصية، فأنشأنا ونشرنا 6 صفحات ثابتة بالعربية والإنجليزية: تعريف وتنزيل، دليل مشاركة واتساب، ومعلومات وصور صحفية. أضيفت canonical/hreflang وبيانات MobileApplication مطابقة للمحتوى وrobots/sitemap وملف حقائق. الصور الثماني مطابقة للصور الأصلية بلا توليد ميزات أو تقييمات. صفحات الخصوصية والشروط والدعم وحذف الحساب وملفاتها ونماذجها كما كانت.

نشر Vercel الإنتاجي `dpl_FufzDD2AZgWoXQTXdoAALnuj3XPg` بحالة READY ورُبط بـ https://voicebrief-legal.vercel.app ؛ العربية `/ar`، والصور والنصوص `/ar/press`. بصمة الموقع (28 ملفًا، 1274446 بايت): `d0fa84eb890b7fbdec41d4591fe77f4d78471edb9bb6aa0f60e75d09dcc9bb5c` وفق طريقة الحساب في `voicebrief_flutter/docs/MARKETING_DISCOVERY.md`. لا تغيير للتطبيق أو الخادم أو الاشتراكات أو بيانات أبل ولا بناء أصلي مطلوب. التحقق محلي مع تأكيد نشر Vercel؛ لم يُجرَ جلب للموقع بعد النشر في هذه الخطوة.

نجحت 9 اختبارات Node وفحص HTML للصفحات الست، وتحقق 24 تركيبة صفحة وعرض (320–1440 بكسل) دون تجاوز أفقي، وتبديل اللغة وتحميل الصور وفتح الأسئلة الشائعة بلوحة المفاتيح. اختُبرت صفحات القانون الأربع باللغتين محليًا دون إرسال النماذج؛ لا أخطاء متصفح ولا قبول أجهزة حقيقية. صور المراجعة في `output/playwright/voicebrief-marketing-20260919/`. أُرسلت الروابط الست إلى Bing IndexNow بتاريخ 2026-09-19T20:50:43Z وأعيد 202: استلام مع انتظار تحقق المفتاح، وليس فهرسة أو ترتيبًا مضمونًا. لا إعادة إرسال ولا متابعة دورية جديدة.

الباقي: ربط Google Search Console وتقديم sitemap يتطلبان حسابًا وصلاحية مالك؛ Product Hunt وAlternativeTo يحتاجان دخول المالك. سُئل عن الحساب المتاح؛ لم يُنشر إدراج خارجي بعد. استُبعد SaaSHub لأن شروطه ترفض النطاقات المجانية. حزمة نصوص نشر حقيقية ومراجع وشروط وقيود موجودة في MARKETING_DISCOVERY؛ لا إنفاق ولا مراجعات مزيفة ولا رسائل جماعية. المحاكيات غير مشمولة بهذا الطلب ولم تُمَس.
