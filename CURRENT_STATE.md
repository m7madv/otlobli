...
Admin now allows only Jordan (JO), United Arab Emirates (AE), Qatar (QA), and Saudi Arabia (SA) for each independent store; the Edge Function rejects any other or malformed region. Jordan now participates in the automatic SHEIN signed-address path. Builds, sync, and Android 86.70 / 930 pass; real JO/AE/QA acceptance remains pending.
Artifact/deploy: app-settings was deployed to project dcicqdprtyhwmhegabay; official Admin production deployment is https://talabieh-admin.vercel.app. iPhone workflow 31263455465 passed from a21edb6; IPA C:\Users\MOHAMMAD\OneDrive\Desktop\otlobli-ios-v86.70\otlobli-v86.70-iphone16-unsigned.ipa (7,066,557 bytes, SHA-256 32BC2AABF2E8005CCFFFA275E69C2A56C4C8B9CEC5B7299BF111A7F72315C6F1).
Build details: local largest JS 1,198,134 / 1,200,000; gzip 355,213 / 370,000; SHEIN source 544,497 / 550,000; Admin JS 265.95 kB. Freeze guard, customer/Admin builds, native sync, Android assemble, iPhone CI, and IPA structure inspection all passed.
