...
- الفرع الصحيح `codex/damanak-simple-pos` ومصدر الإصدار الحالي `4.5.1+29`. Build `28` هو الأحدث في iPhone TestFlight إلى أن يكتمل رفع Build `29`. إصدار Apple `4.5.0` أصبح `READY_FOR_SALE` ولم تعد هناك مسودة مراجعة نشطة، بينما بقي Google Alpha على Build `23`. لا تشغّل إعداد Apple بوضع `apply` ولا تنشئ إصدار App Store جديداً ضمن رفع TestFlight.
...
- App Store Connect: أكد الفحص القرائي [33533818718](https://github.com/m7madv/otlobli/actions/runs/33533818718) أن الإصدار `4.5.0` بالمعرّف `b2914502-195a-4608-83fb-e7356cbc7707` أصبح `READY_FOR_SALE`، ولا توجد مسودة مراجعة نشطة أو إصدار iOS قابل للتعديل. الاشتراكات الستة ومجموعة الاشتراك `22332400` معتمدة، وBuild `4.5.0 (28)` هو الأحدث وحالته `VALID` وداخل `Damanak Internal` ذات المختبر الواحد.
- نجح فحص Build `29` الموقّع بلا رفع في [33531820327](https://github.com/m7madv/otlobli/actions/runs/33531820327). أما محاولة رفع `4.5.0 (29)` في [33532659092](https://github.com/m7madv/otlobli/actions/runs/33532659092) فنجحت في البناء والتوقيع والتصدير ثم رفضتها Apple بالرمزين `90062` و`90186` لأن `4.5.0` صار معتمداً وقطاره مغلقاً؛ لذلك نُقل رقم التسويق فقط إلى `4.5.1+29` قبل إعادة الرفع.
