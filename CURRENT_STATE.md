...
يفحص هوية المشروع، تفويض القبول، وحالة مرسل Otlobli الحية أولًا، ثم يعيد
إرسال `86.244 (1112)` مباشرة. يتخطى هذا الفرع أرشفة iOS والتوقيع ورفع
TestFlight، ولا يغيّر أي ملف تطبيقي أو بناء Apple. ما زال يرفض الإرسال إذا لم
تكن حالة WhatsApp كاملة، ولا يتجاوز حارس الخدمة.
