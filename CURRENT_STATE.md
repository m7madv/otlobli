...
## مشروع ضمانك المستقل 4.0.0 (2026-08-24)

- `damanak_flutter/` إصدار `4.0.0+4` بمعرّف `com.damanak.damanak`. أصبح نظامي تشغيل في تطبيق واحد: الفروع ونقاط البيع والمخزون والمشتريات، ثم الضمان والصيانة. لم يتغير مصدر Otlobli أو دفعه أو محفظته.
- نقطة البيع تدعم سلة متعددة المنتجات، ماسح ضمانك، الأرقام التسلسلية، العميل، الخصم، الضريبة، وتقسيم الدفع. البيع يخصم المخزون وينشئ الضمانات، والمرتجع الجزئي/الكامل يعيد المخزون ويلغي الضمان المرتبط عند اكتماله.
- أضيف مخزون لكل فرع وحد طلب ومتوسط تكلفة وجرد وتحويل وسجل حركة، وموردون وأوامر شراء واستلام، وجلسات صندوق مع رصيد افتتاحي وجرد ختامي وفروقات.
- نموذج الفرع الكامل يحفظ النوع والمدير والتواصل والمنطقة الزمنية وساعات العمل وبادئة الفواتير وقدرات البيع والخدمة. نموذج المنتج يحفظ التكلفة وتتبع المخزون والتسلسل وحد الطلب.
- أضيف `Google/Apple OAuth` وروابط العودة وحذف الحساب. الواجهة عربية بلون واحد، والتنقل هو العمليات/البيع/المخزون/الضمانات/الإدارة. تقرير مهارة Apple Design محدث في `docs/DESIGN_AUDIT.md`.
