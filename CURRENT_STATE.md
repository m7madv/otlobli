...
- أُنتجت خمس صور iPhone بدقة `1284×2778` وخمس صور iPad بدقة `2048×2732` داخل `app_store_assets/ios/`. أُصلحت أثناء المراجعة مشاكل الحروف العربية المكسورة والخطوط الصفراء والدعوة الفارغة وقص عنوان الاشتراك؛ اجتاز المولد `5/5` وما يزال رفع الصور إلى App Store Connect مطلوباً.
