...
1. **آيفون:** بناء ونشر النسخة الجديدة.
2. **لوحة الإدارة (Vercel):** غير عاجلة — تقرأ القيم من القاعدة وهي صحيحة أصلاً؛ التعديل مسّ القيم الافتراضية التي لا تُستعمل إلا لو غاب الصف. نشرها يحتاج دمجاً إلى `main` (وهو عند v86.67) — قرار مستقل.
