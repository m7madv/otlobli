...
- تحقق workflow القراءة فقط `voicebrief-appstore-status.yml` في run `33281439004` من App Store Connect API: البناء `0.1.0 (9)` على iOS حالته `VALID`، غير منتهٍ، ومعرّف البناء `d3788d62-0ca7-423f-b234-425a325012f7` يطابق Delivery UUID. تاريخ الرفع `2026-08-26T19:04:29-07:00` والانتهاء `2026-11-24T18:04:29-08:00` والحد الأدنى iOS 14. تقرير GitHub artifact رقم `9723099055`، حجمه `379` بايت، وبصمته SHA-256 `EB01A2277A1648A622DD5C05EEA0F6DDF5D063DF850035DAFF51927ADF0479CF`.
