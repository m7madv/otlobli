...
- ثُبت تثبيت Build `26` وشراء Apple حقيقي على iPhone من TestFlight، لكن حذف الحساب مباشرةً أنشأ حالة orphan وكشف عدم توافق فاحص v27 مع Edge. ما تزال الاستعادة بعد نشر v28 بحاجة إلى محاولة حقيقية واحدة؛ لا تدّع نجاحها قبل رد تحقق `200` وظهور entitlement في الإنتاج. الشراء/الاستعادة على Android وVoiceOver/TalkBack والجهاز الضعيف بلا قبول نهائي كذلك.
