...
- التحقق المحلي الحالي ناجح: format على 78 ملفاً، analyze بلا مشكلات، 42 اختباراً غير golden، 12 golden، 3 اختبارات JSON محدودة، 13 اختبار تاريخ/مدة صوت بعد منع تكرار الموعد، 3 اختبارات form محدودة، وكل `deno lint/check`، وAndroid debug. APK حجمه `177,653,885` بايت وبصمته SHA-256 `DF67F60678B42A38A0FAC415FC79ECA224F3BDA772123726C153D1FA0C6AE64E`. نجح CI run `33325718503` بكل وظائفه. لم يُرفع build 17 إلى TestFlight بعد.
