...
Apple: المنشور يبقى `4.5.0`؛ مسودة `4.6.0` هي `af5f3581-d237-476d-b8c4-a42c73f7cc19` PREPARE_FOR_SUBMISSION. iOS run `34039342937` نجح و32 صار VALID في TestFlight؛ IPA حجمه 24965730 وبصمته `E4728DFE2289CEC91FD9449AB057A514593F682BE1815B543F2F2DEF6CBBA1A7`. لم يُربط البناء بالمسودة ولم يُرسل طلب مراجعة؛ يلزم وصول مالك Supabase لفحص صلاحية Sandbox قبل المراجعة العامة. التقرير `damanak_flutter/docs/LOCALIZATION_RELEASE_2026-09-06.md` يحفظ التفاصيل.
