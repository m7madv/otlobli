...
- ألغى المالك فرنسا لهذا الإصدار؛ أصبحت متاحة في `174` بلدًا/منطقة مع إبقاء إضافة البلدان المستقبلية تلقائيًا، وتظهر فرنسا `Not Available` في App Store Connect. قد يستغرق انعكاس تغيير التوافر على المتجر حتى 24 ساعة. أُرسلت العناصر الأربعة معًا إلى App Review: إصدار iOS ‏`0.1.0 (18)`، ومجموعة `VoiceBrief Pro`، والاشتراكان `voicebrief_pro_monthly` و`voicebrief_pro_annual`. الحالة الحالية `Waiting for Review`، ووقت الإرسال المعروض `Today at 9:10 AM`، ومعرّف الإرسال `39106dc0-59f4-4c77-9d1f-96ab11a3bb0b`. الإصدار مضبوط على النشر التلقائي بعد موافقة Apple؛ هذا إرسال للمراجعة وليس نشرًا حيًا بعد، وتذكر Apple أن المراجعة قد تستغرق حتى 48 ساعة.
