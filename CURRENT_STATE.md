...
Marker: `2026.08.08-v86.75-shein-sku-safe-space`; native version `86.75 / 935`. `npm run build`, the iPhone freeze guard, and the low-end budget pass: largest JS `1,198,121 / 1,200,000`, gzip `354,558 / 370,000`, SHEIN source `544,453 / 550,000`. The first unsigned iPhone run `31276759661` stopped before Xcode because its secret-bearing CI bundle was 1,157 bytes over budget; non-functional comments inside the shipped script were compacted and iOS re-synchronized before retry. The retry [run `31276863789`](https://github.com/m7madv/otlobli/actions/runs/31276863789) passed from `b4fed85`; unsigned IPA: `C:\Users\MOHAMMAD\OneDrive\Desktop\otlobli-ios-v86.75\otlobli-v86.75-iphone16-unsigned.ipa` (7,065,905 bytes, SHA-256 `954308F6A55E648D6E92CFAEE8FADF606540E64C87092016AD86BDA87CEFD18C`). It still needs the real iPhone acceptance set: quick-add size visibility, five background/resume cycles, and force-quit/cold launch. Do not claim the prior iPhone freeze resolved without those tests.
