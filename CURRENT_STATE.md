...
## VoiceBrief — تحسين النشر والفهرسة، 20 سبتمبر 2026
...
نشر Vercel الإنتاجي الجديد `dpl_8hA7WeQTiv8dymwq28N4sXE81oBu` بحالة READY ورُبط بـ https://voicebrief-legal.vercel.app ؛ العربية `/ar`، والصور والنصوص `/ar/press`. بصمة الموقع (32 ملفًا، 1334506 بايت): `3e8dac6c9c839eb519824fd15ba2b6bbbf521c0b5e6cbb6fcc478129fdabca92` وفق MARKETING_DISCOVERY. النسخة السابقة `dpl_FufzDD2AZgWoXQTXdoAALnuj3XPg` متاحة للتراجع. جُلبت الصفحة العامة السابقة بنجاح قبل العمل؛ قبول هذه الدفعة يعتمد على الاختبار المحلي وتأكيد Vercel، لا جلب جديد بعد النشر. الموقع منفصل عن التطبيق ولا يحتاج بناء أصليًا أو مزامنة مشاريع الهاتف.
...
الباقي: ربط Google Search Console وتقديم sitemap يتطلبان حسابًا وصلاحية مالك؛ Product Hunt وAlternativeTo يحتاجان دخول المالك. AppAgg يوفّر صفحة إضافة لكن أظهر تحققًا بشريًا قبل الوصول للنموذج؛ لم نتجاوزه ولم ننشر إدراجًا. استُبعد SaaSHub لأنه يرفض النطاقات المجانية. حزمة النشر والمراجع والقيود في MARKETING_DISCOVERY؛ لا إنفاق ولا منشورات خارجية مؤكدة ولا مراجعات مزيفة أو رسائل جماعية. لا يجوز الادعاء باكتمال هذه البوابات أو ضمان الظهور.
