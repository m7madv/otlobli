...
- رفع بقية اللغات متوقف على قرار المالك: أبل رفضت إنشاء الإنجليزية بـSTATE_ERROR.DUPLICATE_NAME.DIFFERENT_ACCOUNT. طُلب اعتماد `VoiceBrief: Audio Summaries` للمتجر فقط ووصف مترجم عند الحاجة؛ لم يرد جواب بعد. لا تغيّر الاسم قبل موافقته. AppInfo القابل للتحرير `176e4637-e8be-499e-a3f2-93acf9dfeb92`.
- 0.1.2(21) غير منشور وغير مرفوع إلى TestFlight. workflow الصور inspect افتراضي وprepare لا يقدم مراجعة أو يختار بناء أو يغيّر البلدان. مسارا TestFlight/Google الموقّعان ما زالا مثبتين على20؛ يجب تحديثهما وحماية مشغل الدفع عند طلب رفع21. لغة App Store الأساسية ما زالت العربية ولم تتغير.
