...
## مشروع ضمانك المستقل — Build 23 قيد المراجعة ومصدر 4.5.0+24 (2026-08-31)

- Build `23` هو الحزمة المرسلة فعلياً إلى Apple وGoogle. المصدر وإجراءات GitHub الحالية على `4.5.0+24` بعد مراجعة كاملة للاشتراك والاستعادة؛ تغييرات Flutter الجديدة ليست داخل Build `23` وتحتاج قرار إصدار وحزمة منفصلة. بقي `scripts/app_store_setup.mjs` على Build `23` ليعبر عن submission الجاري.
