...
## VoiceBrief — ربط Google Search Console والفهرسة، 20 سبتمبر 2026
...
بناءً على طلب المالك الاستمرار حتى الإكمال، أُنشئت متابعة داخل هذه المحادثة باسم «متابعة فهرسة VoiceBrief»، المعرّف `voicebrief`، وحالتها ACTIVE. موعدها اليومي 09:00 بتوقيت الرياض، مع شرط عدم تنفيذ فحص أو طلب قبل21سبتمبر2026 وانتظار24ساعة على الأقل بعد أي رفض للحصة. نطاقها الصفحة الرئيسية و`/ar` فقط وحساب المالك الموافق عليه؛ لا تكرار لطلب قُبل سابقًا ولا إعادة خريطة الموقع ولا تبديل حسابات. تبلغ بتغيّر مهم أو حاجة لتدخل، وتتوقف عند تأكيد فهرسة الصفحتين. تتطلب بقاء الكمبيوتر وتطبيق Codex يعملان وتوفر جلسة Google؛ نجاح إنشاء المتابعة ليس إثبات تنفيذها أو اكتمال الفهرسة. هذه الدفعة أتمتة وتوثيق فقط؛ نشر الموقع وبصمته والاختبارات أعلاه لم تتغير ولا يلزم بناء أصلي.
