...
لم يُرسل OTP حقيقي في هذه الدفعة ولم يُنشأ حساب أو جلسة عميل إنتاجية.
طُلب من المالك اختبار طلب الرمز ووصوله والدخول من نسخته الحالية؛ القبول
الفعلي ما زال منتظرًا. هذه الدفعة لرموز الدخول/توثيق الهاتف، وليست لتنبيهات
