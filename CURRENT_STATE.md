...
- العوائق الصحيحة قبل إرسال Apple هي: اسم صاحب الحقوق بصيغة `2026 <الاسم القانوني>`، بيانات جهة اتصال App Review، حساب مراجعة صالح مع كلمة مرور يدخلها المالك بنفسه، إقرار Content Rights، وحسم امتثال التشفير لفرنسا. IPA البناء 18 يحتوي `ITSAppUsesNonExemptEncryption=false` لكنه يضم TLS معياريًا من Flutter/Dart عبر BoringSSL؛ إبقاء فرنسا ضمن التوزيع يتطلب إجابة صادقة في استبيان التشفير وقد يتطلب تصريحًا فرنسيًا ورمز امتثال وإعادة بناء. لا يُدّعى أن النسخة أُرسلت أو نُشرت لدى Apple.
