...
- workflow `damanak-ios-unsigned.yml` محدث لإصدار `2.0.0`؛ بناء GitHub/iOS الجديد ينتظر دفع هذه الدفعة. النسخة `1.0.0` القديمة ما زالت موثقة في سجل GitHub ولا تمثل النظام الحالي.
