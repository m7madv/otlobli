...
## مشروع ضمانك المستقل — Build 25 قيد التجهيز لـTestFlight وBuild 23 قيد المراجعة (2026-09-01)
...
- App Store Connect: submission `69104e50-7a9a-4102-a717-ca341d442897` ما يزال يضم Build `23` ومجموعة الاشتراك والمنتجات الستة، أي 8 عناصر، وحالته الموثقة `Waiting for Review`. لا تلغِه أو تستبدل بناءه أثناء المراجعة. Build `24` TestFlight معرّفه `6b986de0-74bb-4649-8619-846aca1eb1b0`، وIPA بصمتها `EA55D5F1192886EE9019F0048E3476C1D5416E047B4F1F1823D234FC56BCF768`. Build `25` لم يُرفع بعد عند هذه النقطة.
