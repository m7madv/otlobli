...
بناء أو رفع جديد. جلسة Oracle المفتوحة انتهت، ولا يوجد سر الإدارة في GitHub
أو مفتاح SSH محلي؛ يلزم استعادة دخول Oracle ثم إعادة وصل الجلسة المحفوظة `0`
عبر المسار المحلي المحمي، وبعدها يعاد تشغيل الإرسال السريع نفسه.
