...
بناء Android. بعد تحديد مسار closed الصحيح يتحول السجل إلى `publish` مرتبط
باسم المسار نفسه قبل رفع الملف والـcommit.

أداة LDPlayer الفعلية هي `C:\LDPlayer\LDPlayer9\ldconsole.exe`. أعادت 12
مثيلًا بالأرقام `0..11`؛ تثبيت LDPlayer4 القديم لم يُعد أي مثيل، ويوجد AVD
واحد من Android Studio باسم `Diagnostic_API_36` منفصل ولن يُمس. ما زال يلزم
مطابقة الحسابات الأربعة عشر التي ذكرها المالك مع المثيلات الفعلية من دون طباعة
عناوينها أو كلمات مرورها.
