...
- مصدر iOS يتضمن Share Extension والتقويم والقص الأصلي، لكنه لم يُبنَ على Windows. يلزم macOS/Xcode وتوقيع واختبار iPhone حقيقي قبل قبول iOS. نقطة الرجوع السابقة هي `voicebrief-prebuild-20260824`، وApple Design Skill مثبت عند `d0bac1e765a27a696839e62962e36330ce72f0b7`.

## مشروع ضمانك المستقل 4.1.0+7 (2026-08-24)
...
- Google Play: سجل التطبيق `Damanak - ضمانك` رقمه `4975804725938350009`. فُعّلت Android Publisher API، وأضيف حساب الخدمة `damanak-play-verifier@damanak-production.iam.gserviceaccount.com` بأذونات التطبيق المحدودة، وحُفظ JSON في Supabase وGitHub. المفتاح المستخدم رقمه `426377cca3335db2db9a17611153fb1b37e92a1d`؛ المفتاح الأول المفقود `d86a3e51984e7ba7b942f00595a37c268b367316` بقي مسجلاً عند آخر فحص ويحتاج تأكيد المستخدم قبل حذفه. الإصدار الداخلي `4.1.0 (7)` رُفع ونُشر؛ رابط الانضمام `https://play.google.com/apps/internaltest/4701722430109624070`، لكن قائمة البريد لم تُحفظ بعد.
