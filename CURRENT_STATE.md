...
- حُفظت بيانات القائمة العربية في Google Play مع الأيقونة وFeature Graphic وأربع صور هاتف. بعد تأكيد المستخدم الإجرائي، رُبطت قائمة `All Apps - Closed Testers` ذات 12 عضوًا بمسار الاختبار المغلق `Alpha`، واختيرت جميع المناطق المتاحة: `176` بلدًا/منطقة إضافة إلى «بقية بلدان العالم». يعرض إعداد Alpha اكتمال مهمتي البلدان والمختبرين من أصل 4، لكن المسار ما زال غير نشط وبلا إصدار؛ التغييرات محفوظة في «نظرة عامة على النشر» ولم تُرسل للمراجعة لأن زر الإرسال معطل حتى اكتمال بريد الاتصال وIARC وTarget audience وData Safety ودخول المراجع. عدد المنضمين الفعلي ما زال 0، ولم تبدأ مدة 14 يومًا، ولم يبدأ نشر Apple أو Google العام.
...
- راجعت الشيفرة وAPK للبناء 18 لإعداد Google Data Safety وIARC والجمهور. APK لا يطلب `AD_ID` أو الموقع أو جهات الاتصال أو التخزين الواسع. التصريح الآمن يتطلب جمع البريد/معرّف المستخدم/الاسم/صورة المزود عند توفرها/سجل الشراء/الصوت وبيانات الملف/المحتوى المولّد/إجراءات الاستخدام/التشخيص/اللغة والمنطقة الزمنية، مع عدم ادعاء مشاركة خارج مزودي الخدمة. لم يُحفظ أو يُرسل التصريح؛ رابط `https://voicebrief-legal.vercel.app/delete-account` يعيد 404 والسياسة العامة ما زالت نسخة 24 أغسطس، لذلك يلزم نشر السياسة المحدثة ورابط حذف حقيقي واعتماد المالك قبل الإرسال. الفئة محفوظة أصلًا `Productivity` لكن بريد التواصل العام فارغ، وTarget audience محجوب حتى حفظ تعليمات دخول المراجع.
