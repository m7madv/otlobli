...
- آخر بناء Apple مرفوع قبل دفع build 18 هو build 17. نجح TestFlight run `33327898649` في الأرشفة والتوقيع وفحص التطبيق وShare Extension والملفات والاستحقاقات والتحقق والرفع. IPA `VoiceBrief-0.1.0-build17-AppStore.ipa` حجمه `34,634,674` بايت وبصمته SHA-256 `5FB74810929DC7D20FF88493F64B7C24F127B9D690CBD2122A68D6C670B388F3`؛ Delivery UUID/build ID هو `e76f600f-70a6-4ef6-bb6d-0944dd939675`. GitHub artifact رقم `9736983367` وحجمه `34,385,468` بايت وبصمة ZIP `5C0119A69D8EE919B7CF9D6D051E07656A71A0FAA3EADA479748351AE9FCC847`.
- أكد App Store status run `33327898729` أن `0.1.0 (17)` حالته `VALID` وغير منتهٍ وموجود في `VoiceBrief Internal`، وتاريخ رفعه `2026-08-30T11:39:41-07:00` وانتهاؤه `2026-11-28T10:39:41-08:00`. تقرير الحالة artifact رقم `9737040568` وحجمه `442` بايت وبصمة ZIP `DE2019F57F9071815F91E3319A864B855AC1266BBE40743B65EBD90BC1D89F2B`. البناء متاح للاختبار الداخلي فقط؛ لم يبدأ نشر Apple أو Google العام، ويبقى قبول iPhone الحقيقي للمظهر والحصة والمنبّه والصوت المخصص مطلوباً.
- رُفعت أربع صور iPhone وأربع صور iPad إلى صفحة الإصدار في App Store Connect، وجُهزت أيقونة وFeature Graphic وأربع صور هاتف لـGoogle Play؛ حفظ/إرسال بيانات المتجر لم يتم بعد. لدى Google مجموعة `All Apps - Closed Testers` بعدد 12، لكن ربطها بالمسار ينتظر تأكيد الإجراء، وعدد المنضمين الفعلي ما زال 0. النشر العام على Google يحتاج 12 منضمًا لمدة 14 يومًا متواصلة ثم طلب Production access.
