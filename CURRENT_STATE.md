...
## مشروع ضمانك المستقل 4.3.0+17 (2026-08-27)

- `damanak_flutter/` هو المصدر الحالي للإصدار `4.3.0+17`، وتجربته التشغيلية «الضمان أولاً»: الوصول إلى إصدار الضمان والبحث والمشاركة والمتابعة هو المسار الأبرز، مع بقاء البيع والمخزون والإدارة متاحة.
...
- أُصلح مسار الأسعار على iOS ليستخدم StoreKit 2 بمهل وتعافٍ واضحين من دون إجبار StoreKit 1 قبل إنشاء عميل الشراء.
...
- التحقق الحالي: `flutter analyze` بلا مشاكل، و`45` اختباراً ناجحاً، و`6/6` لقطات ناجحة ومراجعة بصرياً، وبناء Flutter Web وAndroid debug ناجحان.
- تعذر Android release المحلي فقط لغياب أسرار التوقيع في البيئة المحلية. لم تُنفذ بعد تجارب Build `17` على أجهزة حقيقية أو عبر App Store وGoogle Play؛ لذلك لا يوجد ادعاء قبول للشراء أو الاستعادة أو أسعار المتجر على هذا البناء.
