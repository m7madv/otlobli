...
Marker: `2026.08.09-v86.79-shein-cart-product-link`; native version `86.79 / 939`. Local validation passes: freeze guard, `npm run build`, performance budget (largest JS `1,198,378 / 1,200,000`, gzip `354,659 / 370,000`, SHEIN source `543,629 / 550,000`), patch reversibility and Android/iOS synchronization. iPhone IPA workflow/artifact and real-device acceptance are pending; acceptance must cover opening the existing cart item, a newly quick-added item, five background/resume cycles, and a force-quit/cold launch.
