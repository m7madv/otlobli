...
- GitHub Actions run `32788817963` passed from commit `67332f4`: Linux completed format, analyze, all 25 non-golden tests, and the Android debug APK; Windows completed all eight platform-stable golden tests; macOS completed `pod install`, the unsigned release iOS build, bundle-ID/Share Extension checks, IPA packaging, and artifact upload.
