...
4. Add the Google Play app connection with package `app.voicebrief.mobile` and upload the prepared private service-account JSON. Do not commit or print either store credential.
