...
Apple chooses storefront localization according to available localizations, the customer's language settings and storefront; an in-app language override cannot control the App Store page. English is the fallback content, not a promise that every region will display a specific language.
