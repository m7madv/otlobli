...
- [ ] Signed physical-iPhone build 14 AlarmKit permission, near-future alarm UI/sound in silent and Focus modes, appointment card, ambiguous-time confirmation, calendar action, cold/warm/terminated notification routing, session refresh/sign-out, App Group cleanup, and playback/seek/trim acceptance. Build 13's appointment card and calendar action passed; its local-notification alarm substitute failed product acceptance.
