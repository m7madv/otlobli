...
- App Store status run [33310667046](https://github.com/m7madv/otlobli/actions/runs/33310667046) confirms historical build `0.1.0 (13)` is `VALID`, unexpired, and attached to `VoiceBrief Internal`. Status artifact `9732090968` has ZIP SHA-256 `760F65D86C11F37CEC16DFFB3E443E88914085FC6839DDC66D5AB57C81963A82`. Its appointment/calendar path passed physical testing; its local-notification alarm substitute failed product acceptance. Build 14 TestFlight validation is pending.
