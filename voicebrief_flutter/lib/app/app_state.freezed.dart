...
@override
int get hashCode => Object.hash(runtimeType,user,authBusy,themeMode,languageCode,navigationIndex,subscription,audioImporting,selectedAudio,processingOptions,processingStep,processing,activeResult,resultNavigationRequest,const DeepCollectionEquality().hash(history),errorMessage);

@override
String toString() {
  return 'AppState(user: $user, authBusy: $authBusy, themeMode: $themeMode, languageCode: $languageCode, navigationIndex: $navigationIndex, subscription: $subscription, audioImporting: $audioImporting, selectedAudio: $selectedAudio, processingOptions: $processingOptions, processingStep: $processingStep, processing: $processing, activeResult: $activeResult, resultNavigationRequest: $resultNavigationRequest, history: $history, errorMessage: $errorMessage)';
}
...
/// Create a copy of AppState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? user = freezed,Object? authBusy = null,Object? themeMode = null,Object? languageCode = freezed,Object? navigationIndex = null,Object? subscription = null,Object? audioImporting = null,Object? selectedAudio = freezed,Object? processingOptions = null,Object? processingStep = null,Object? processing = null,Object? activeResult = freezed,Object? resultNavigationRequest = null,Object? history = null,Object? errorMessage = freezed,}) {
...
as String?,navigationIndex: null == navigationIndex ? _self.navigationIndex : navigationIndex // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AuthUser? user,  bool authBusy,  ThemeMode themeMode,  String? languageCode,  int navigationIndex,  SubscriptionStatus subscription,  bool audioImporting,  AudioInput? selectedAudio,  ProcessingOptions processingOptions,  ProcessingStep processingStep,  bool processing,  BriefResult? activeResult,  int resultNavigationRequest,  List<BriefResult> history,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppState() when $default != null:
return $default(_that.user,_that.authBusy,_that.themeMode,_that.languageCode,_that.navigationIndex,_that.subscription,_that.audioImporting,_that.selectedAudio,_that.processingOptions,_that.processingStep,_that.processing,_that.activeResult,_that.resultNavigationRequest,_that.history,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AuthUser? user,  bool authBusy,  ThemeMode themeMode,  String? languageCode,  int navigationIndex,  SubscriptionStatus subscription,  bool audioImporting,  AudioInput? selectedAudio,  ProcessingOptions processingOptions,  ProcessingStep processingStep,  bool processing,  BriefResult? activeResult,  int resultNavigationRequest,  List<BriefResult> history,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _AppState():
return $default(_that.user,_that.authBusy,_that.themeMode,_that.languageCode,_that.navigationIndex,_that.subscription,_that.audioImporting,_that.selectedAudio,_that.processingOptions,_that.processingStep,_that.processing,_that.activeResult,_that.resultNavigationRequest,_that.history,_that.errorMessage);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AuthUser? user,  bool authBusy,  ThemeMode themeMode,  String? languageCode,  int navigationIndex,  SubscriptionStatus subscription,  bool audioImporting,  AudioInput? selectedAudio,  ProcessingOptions processingOptions,  ProcessingStep processingStep,  bool processing,  BriefResult? activeResult,  int resultNavigationRequest,  List<BriefResult> history,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _AppState() when $default != null:
return $default(_that.user,_that.authBusy,_that.themeMode,_that.languageCode,_that.navigationIndex,_that.subscription,_that.audioImporting,_that.selectedAudio,_that.processingOptions,_that.processingStep,_that.processing,_that.activeResult,_that.resultNavigationRequest,_that.history,_that.errorMessage);case _:
  return null;
...
class _AppState implements AppState {
  const _AppState({this.user, this.authBusy = false, this.themeMode = ThemeMode.system, this.languageCode, this.navigationIndex = 0, this.subscription = const SubscriptionStatus(tier: SubscriptionTier.free, remainingMinutes: 10, totalMinutes: 10), this.audioImporting = false, this.selectedAudio, this.processingOptions = const ProcessingOptions(), this.processingStep = ProcessingStep.preparing, this.processing = false, this.activeResult, this.resultNavigationRequest = 0, final  List<BriefResult> history = const [], this.errorMessage}): _history = history;
...
@override
int get hashCode => Object.hash(runtimeType,user,authBusy,themeMode,languageCode,navigationIndex,subscription,audioImporting,selectedAudio,processingOptions,processingStep,processing,activeResult,resultNavigationRequest,const DeepCollectionEquality().hash(_history),errorMessage);
...
/// Create a copy of AppState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? user = freezed,Object? authBusy = null,Object? themeMode = null,Object? languageCode = freezed,Object? navigationIndex = null,Object? subscription = null,Object? audioImporting = null,Object? selectedAudio = freezed,Object? processingOptions = null,Object? processingStep = null,Object? processing = null,Object? activeResult = freezed,Object? resultNavigationRequest = null,Object? history = null,Object? errorMessage = freezed,}) {
