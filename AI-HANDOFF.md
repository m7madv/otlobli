...
- الصور المعتمدة تحت `app_store_assets/ios/iphone-1284x2778/` و`app_store_assets/ios/ipad-2048x2732/`. المولد `tool/app_store_marketing_screenshots_test.dart` اجتاز `5/5`. سكربت `scripts/app_store_screenshots.mjs` وإجراء `damanak-app-store-screenshots.yml` يرفعان المجموعتين آلياً؛ لا تستخدم ملفات المحاكي المؤقتة.
