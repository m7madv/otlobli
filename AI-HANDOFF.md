...
- workflow الصور لا يختار بناء ولا يقدم أو ينشر. TestFlight حُدّث21 مع تحقق11لغة وإلغاء مشغل push لمنع الرفع المكرر؛ شغله مرة واحدة صراحة. Google وstatus القديم لا يزالان20؛ لا تستخدمهما لإدارة21. Build21 لم يرفع بعد عند هذا التوثيق.
- المتابعة المصرّح بها: إكمال11لغة متجر/88صورة، رفع21 والتحقق من VALID واختياره ثم تقديمه وإصداره. حافظ على استثناء فرنسا ومعرفات التطبيق والحساب والاشتراكات. لا قبول أجهزة فعلية أو مراجعة بشرية للترجمات حتى الآن؛ لا تدّعِ تحققها. اللغة الأساسية للمتجر تبقى العربية.
