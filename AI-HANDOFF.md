...
- آخر بناء Apple المرفوع حاليًا هو build 17: TestFlight run `33327898649` رفع IPA بصمة `5FB74810929DC7D20FF88493F64B7C24F127B9D690CBD2122A68D6C670B388F3`، وstatus run `33327898729` أكد `VALID` و`VoiceBrief Internal`. build 18 لم يُرفع بعد؛ رفعه يبدأ بعد commit/push واجتياز workflow.
- رُفعت أربع صور iPhone وأربع صور iPad إلى App Store Connect. جُهزت أصول Google Play، لكن حفظ صفحة المتجر لم يُنفذ. المجموعة الصحيحة لاختبار Google هي `All Apps - Closed Testers` وبها 12 حساباً؛ لم تُربط بعد، والمنضمون الفعليون 0. يحتاج النشر العام 12 منضمًا فعلياً مدة 14 يومًا متواصلة ثم طلب Production access.
