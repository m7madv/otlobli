...
Version/build is `86.197/1059`; marker `2026.08.20-v86.197-inactive-scheduling-throttle`. Local build/gates and GitHub/Xcode run `32382985235` pass from code commit `deb5325`; artifact ID `9411857885`. The inspected IPA is `6,556,233` bytes, SHA-256 `27BE184E0409E71EAC3B8EF08ECE25D0B78CF6F3A1BFE4D13C917289F2A603E2`, ARM64, iOS 15+, iPhone/iPad `[1,2]`, app-level unsigned/unprovisioned, with no source maps or relay placeholder. Binary inspection confirms `setInactiveSchedulingPolicy:`. Desktop path: `C:\Users\MOHAMMAD\Desktop\otlobli-ios-v86.197-inactive-scheduling-fix\otlobli-v86.197-ipad-iphone-universal-unsigned.ipa`. Real-iPhone acceptance remains pending. Required device gate: first healthy entry; five background/resume cycles with list/PDP interaction after each; force-quit/cold launch and second entry; then SHEIN → Temu → SHEIN. A successful build is not device proof.
