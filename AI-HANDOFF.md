...
- نُشر build 18 إلى Google Play ‏`internal` فقط عبر run `33341090128` من `26b99e8e8e6132e14f7b26a61e5361178667289b`. التقرير يثبت `committed:true` و`completed` للإصدار 18 وبصمة AAB الصحيحة؛ artifact رقم `9740576360` وبصمته API ‏`sha256:b98c07031726bcb38cf88b000dc7a7d01ab3a2874102788a706ab39f32f87647`، وملف التقرير `838` بايت وبصمته `6E42CB83EBBBA56450A800647544F5D823F83A7BAB22EAB3E56A95F58D324E36`. Play Console يعرض `VoiceBrief 0.1.0 build 18` «متاح للمختبِرين الداخليين»، لكن المسار «غير نشط» لأن قائمة المختبرين غير مربوطة؛ هذا ليس نشر Production.
- ناشر Google المحروس موجود على `main` عند `d11c8ec` وعلى فرع VoiceBrief عند `26b99e8`. بيئة `voicebrief-google-play-internal` محمية ومقيدة بالفرع؛ مُنح حساب الخدمة لتطبيق VoiceBrief فقط إذن «إصدار تطبيقات للجماهير المستهدفة للاختبار» من دون إذن Production، وحُذف السر المؤقت `VOICEBRIEF_AAB_SIGNED_URL` بعد نجاح التشغيل. لا تربط مجموعة المختبرين دون تأكيد الإجراء المتفق عليه.
- رُفعت أربع صور iPhone وأربع صور iPad إلى App Store Connect، وحُفظت بيانات Google العربية مع الأيقونة وFeature Graphic وأربع صور هاتف. بقي في Google بريد الاتصال وIARC وقبول شروطه وTarget audience وData Safety ودخول المراجع. مجموعة `All Apps - Closed Testers` بها 12 عضوًا لكنها غير مربوطة والمنضمون الفعليون 0؛ يحتاج النشر العام 12 منضمًا فعليًا مدة 14 يومًا متواصلة ثم طلب Production access.
