...
- Google Cloud مكتمل وOAuth ما يزال External/Testing مع `mhm1981x@gmail.com`؛ Note 8 يحتوي `mhm1981d@gmail.com` فقط. RevenueCat ومنتجات المتاجر وApple signing لم تكتمل. فرع GitHub `codex/voicebrief-ios` عند `67332f4` اجتاز run `32788817963`: Android، ثماني golden على Windows، وmacOS iOS release بلا توقيع مع Share Extension مضمّنة. IPA حجمها `16,807,014` وبصمتها `79064717F6E26FC6DAA9D3CE30BEADB302AA581C82F618C7C2239E45D1AD900C` تحت `output/github-run-32788817963/`. هي بلا provisioning ولا تصلح للتثبيت العادي؛ لا تدّعِ قبول iOS قبل التوقيع وتجربة iPhone الحقيقي.
