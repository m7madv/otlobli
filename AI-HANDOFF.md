...
- التحقق المحلي للبناء 12 نجح: 71 ملف format، analyze، 32 non-golden، 11 golden، وAPK debug بصمة `37729DAFEECC45CE66DF870AA167D4E660A7F3167C62E3352C003C3818029FE5`. اختبار النتيجة المشتركة يمرر `importantDates` حقيقياً، يحفظه، ويثبت طلب الانتقال إلى شاشة النتيجة. انتظر CI/TestFlight ثم اختبر على iPhone: اسمح بالإشعارات، شارك من WhatsApp، أبقِ نافذة المشاركة مفتوحة حتى تُغلق، اضغط إشعار الجاهزية، وتحقق من فتح الملخص ومن ظهور الموعد وزر التقويم. لا تدّع قبول جهاز قبل ذلك.
