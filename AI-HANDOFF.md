...
- Google Cloud مكتمل وOAuth ما يزال External/Testing مع `mhm1981x@gmail.com`؛ Note 8 يحتوي `mhm1981d@gmail.com` فقط. RevenueCat ومنتجات المتاجر وApple signing لم تكتمل. iOS يحتوي المصدر الأصلي للمشاركة والتقويم والقص، لكن يلزم macOS/Xcode وتوقيع واختبار iPhone حقيقي؛ لا تدّعِ قبول iOS من Windows.
- نقطة الرجوع `voicebrief-prebuild-20260824`، وApple Design Skill مثبت عند `d0bac1e765a27a696839e62962e36330ce72f0b7`.

## مشروع مستقل (2026-08-24) — ضمانك 4.1.0+7
...
- Google Play app رقم `4975804725938350009`. الإصدار الداخلي `4.1.0 (7)` منشور، ورابط الانضمام `https://play.google.com/apps/internaltest/4701722430109624070`. قائمة مختبر البريد لم تُحفظ بعد. حساب الخدمة نشط وJSON موجود في Supabase/GitHub، والمفتاح العامل هو `426377cca3335db2db9a17611153fb1b37e92a1d`. المفتاح المفقود `d86a3e51984e7ba7b942f00595a37c268b367316` ما يزال يحتاج حذفاً بعد تأكيد المستخدم. مفتاح Android المحلي ليس في GitHub.
