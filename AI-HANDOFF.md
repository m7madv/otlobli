...
## مشروع مستقل (2026-09-01) — ضمانك مصدر Build 29 وإعادة بناء الاشتراكات

- الفرع الصحيح `codex/damanak-simple-pos`، والمصدر الحالي `4.5.0+29`. Build `28` أحدث iPhone TestFlight إلى أن يكتمل رفع Build `29`، وBuild `23` بقي داخل App Review وGoogle Alpha. لا تغيّر `scripts/app_store_setup.mjs` عن Build `23` ولا تمس submission `69104e50-7a9a-4102-a717-ca341d442897` أثناء المراجعة.
...
- التحقق المحلي للمصدر `4.5.0+29`: `flutter analyze` نظيف، وFlutter `211/211`، واختبارات الاشتراك المركزة `69/69` بمراجعة خصومية مستقلة، وDeno `77/77`، و`deno fmt --check` على 27 ملفاً و`git diff --check` ناجحة. نجح web release وAndroid debug؛ APK المحلي حجمه `208,066,330` وبصمته `08D0DDEC1E1BA1C734DA36C1F4CDCA5F2B77543D8044A8D523435E034E14A0AE`.
...
- Apple: Build `23` submission ذو 8 عناصر ما تزال حالته `Waiting for Review`. رفع run [33481729437](https://github.com/m7madv/otlobli/actions/runs/33481729437) الالتزام `e073cd5f7fad489f094337a142c46786eda2d57f` بوصفه Build `4.5.0 (27)`؛ صار `VALID` بالمعرّف/Delivery UUID `5b04b5da-22e5-4cc9-affc-691e3b7e840f` وداخل `Damanak Internal` ذات مختبر واحد. IPA المحلية `damanak_flutter/output/github-run-33481729437/ضمانك.ipa` حجمها `23,943,985` وبصمتها `808712BDD6E46942C9CE837B01FC329ED1CE25A3FC47E95F577BEC03790E2547`. لم يُضف إلى App Review، وأكد فحص القراءة [33482932576](https://github.com/m7madv/otlobli/actions/runs/33482932576) المعالجة والربط وبقاء الإصدار `WAITING_FOR_REVIEW` من دون أي mutation.
- Apple Build `4.5.0 (28)`: نجح فحص macOS الموقّع بلا رفع في run [33520286056](https://github.com/m7madv/otlobli/actions/runs/33520286056)، ثم نجح التحقق والرفع من commit `baaa3e151036d280d8c2ca17f5b069f3aa9e44e8` في run [33520953615](https://github.com/m7madv/otlobli/actions/runs/33520953615). أكد inspect [33522527864](https://github.com/m7madv/otlobli/actions/runs/33522527864) أنه `VALID` بالمعرّف/Delivery UUID `a9038423-e4fc-4499-8c04-bba4c0f1d317` وداخل `Damanak Internal` ذات مختبر واحد، وأن App Review بقي `WAITING_FOR_REVIEW` مع `mutationRequested=false`. IPA المحلية `damanak_flutter/output/github-run-33520953615/ضمانك.ipa` حجمها `23,963,467` وبصمتها `230304290CE79C5E8F47A1D511DC8C845846C88BF529F7D167CA87B07BA65561`.
