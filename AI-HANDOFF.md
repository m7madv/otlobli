...
- لا تُكمل إرسال Apple قبل استلام الاسم القانوني لحقوق النشر، وبيانات جهة اتصال المراجعة، واعتماد حساب المراجعة، وإدخال المالك لكلمة المرور مباشرة في المتصفح، وتأكيد Content Rights. التوزيع يشمل فرنسا، بينما build 18 يضم TLS معياريًا من Flutter/Dart عبر BoringSSL رغم `ITSAppUsesNonExemptEncryption=false`؛ يلزم إما تصريح فرنسا/رمز الامتثال وإعادة بناء عند طلبه، أو موافقة المالك الصريحة على استبعاد فرنسا مؤقتًا. لا تستنتج أي تصريح قانوني من اسم الحساب.
