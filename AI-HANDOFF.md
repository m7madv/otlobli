...
- المسار العام `/delete-account` والسياسة المحدثة محليان حتى نشر دالة `legal`. النموذج يسجل طلباً للتحقق اليدوي ولا ينفذ الحذف تلقائياً، وإلغاء اشتراك المتجر خطوة منفصلة.
...
- بعد تأكيد المستخدم الصريح، رُبطت قائمة `All Apps - Closed Testers` ذات 12 عضوًا بمسار Google المغلق `Alpha`، واختيرت جميع المناطق: `176` بلدًا/منطقة و«بقية بلدان العالم». إعداد Alpha يسجل مهمتي البلدان والمختبرين مكتملتين من أصل 4، لكنه غير نشط وبلا إصدار. التغييرات ظاهرة في «نظرة عامة على النشر» ولم تُرسل للمراجعة لأن زر الإرسال معطل حتى اكتمال بريد الاتصال وIARC وTarget audience وData Safety ودخول المراجع. المنضمون الفعليون 0 ولم تبدأ مدة 14 يومًا؛ لا تدّع بدء الاختبار المغلق أو النشر العام.
...
- تدقيق Data Safety/IARC جاهز من المصدر وAPK لكنه لم يُرسل. رابط حذف الحساب العام على Vercel يعيد 404 والسياسة المنشورة أقدم من خريطة بيانات build 18، بينما مسار `/delete-account` والسياسة الجديدة ما زالا محليين. لا تحفظ Data Safety أو تقبل IARC/تحدد عمر الجمهور أو تنشر بريدًا عامًا نيابة عن المالك. المطلوب منه: بريد تواصل مراقب مع موافقة عرضه علنًا ومشاركته مع IARC، اعتماد `18+` أو بديله، قبول شروط IARC والتصريح، واعتماد/نشر النص القانوني ورابط الحذف. تعليمات المراجع المقترحة تعتمد Google بأي حساب مراجع ولا تحتاج كلمة مرور خاصة بعد نجاح اختبار Play-signed.
