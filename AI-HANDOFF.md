...
## مشروع مستقل (2026-08-31) — ضمانك Build 23 قيد المراجعة ومصدر 4.5.0+24

- الفرع الصحيح `codex/damanak-simple-pos`. Build `23` هو المرسل للمتجرين؛ المصدر وإجراءات GitHub الحالية `4.5.0+24`. لا تنسب رقع Flutter الجديدة إلى Build `23`، ولا ترفع Build `24` أو تغيّر submission Apple الجاري بلا قرار إصدار صريح. `scripts/app_store_setup.mjs` يبقى على Build `23` حتى ذلك القرار.
