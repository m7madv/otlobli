...
## مشروع مستقل (2026-08-27) — ضمانك 4.3.0+17

- المصدر الحالي هو `damanak_flutter/` بالإصدار `4.3.0+17`. حافظ على تجربة «الضمان أولاً» وعلى شاشة الاشتراك المبسطة؛ خطة نمو هي الموصى بها والاستعادة وإدارة الاشتراك واضحتان.
...
- لا تغيّر معرّفات منتجات Apple/Google أو تضف أسعاراً ثابتة؛ السعر والعملة يجب أن يأتيا من المتجر. حافظ على إصلاح StoreKit 2 ولا تُجبر StoreKit 1 قبل إنشاء عميل الشراء.
...
- تحقق التسليم: `flutter analyze` بلا مشاكل، `45` اختباراً ناجحاً، `6/6` لقطات ناجحة ومراجعة بصرياً، وبناء Flutter Web وAndroid debug ناجحان. تعذر Android release المحلي فقط لغياب أسرار التوقيع.
- الخطوة التالية هي بناء وتوقيع Build `17` في البيئة المعتمدة ثم اختباره على iPhone وAndroid حقيقيين ومع كتالوجي App Store وGoogle Play، بما يشمل جلب السعر والشراء والاستعادة والتحقق الخادمي. لا تسجل قبولاً قبل تنفيذ هذه التجارب.
