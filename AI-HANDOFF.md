...
- أبل تؤكد0.1.1 READY_FOR_SALE. أنشئت مسودة0.1.2 ID `4ad274c0-fb1f-4f61-947a-ce57c461554c`؛ صور العربية الثماني COMPLETE، وبقية اللغات لم ترفع. تقرير ونسخ قبل الاستبدال في `output/voicebrief-localization-20260906/` وartifact تشغيل34036907851؛ النسخة العامة لم تتغير.
- **قرار معلق لدى المالك:** تعارض اسم VoiceBrief عند إنشاء en-US مع حساب آخر. ينتظر سؤال اعتماد `VoiceBrief: Audio Summaries` للمتجر فقط ووصف مترجم عند الحاجة؛ لا تتجاوز القرار. بعد الموافقة: أنشئ AppInfoLocalization بالاسم المعتمد أولًا، ثم VersionLocalization؛ عدّل السكربت لهذا المسار، فهو يتوقف حاليًا عند الإنجليزية. AppInfo القابل للتحرير `176e4637-e8be-499e-a3f2-93acf9dfeb92`؛ لا تمس المنشور `77f9a1b5-31d1-47ec-8166-b2a1c63ceba5`. وضع inspect يقرأ كليهما.
- workflow صور المتجر لا يختار بناء ولا يقدم أو ينشر. Build21 لم يرفع إلى TestFlight/Google. المساران الموقّعان مثبتان على20؛ حدّثهما عند طلب رفع21 وانتبه أن تعديل ملف TestFlight قد يشغّل رفعًا تلقائيًا عند الدفع. لا تستخدم status workflow القديم لإدارة21.
- يبقى قبل الإصدار: موافقة الاسم وإكمال11لغة متجر/88صورة، رفع بناء21 واختياره بطلب المالك، اختبار تبديل اللغات والمشاركة والأذونات على أجهزة فعلية ومراجعة لغوية بشرية. اللغة الأساسية للمتجر تبقى العربية؛ اختيار الإنجليزية كـfallback داخل التطبيق لا يغيّرها.
