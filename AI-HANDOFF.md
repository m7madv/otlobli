...
## مشروع مستقل (2026-08-30) — ضمانك 4.3.1+19

- المصدر الحالي `damanak_flutter/` بالإصدار `4.3.1+19`. حافظ على تجربة «الضمان أولاً»، وحصص `100/600/3000` وحدود الفريق `2/5/15`.
...
- تحقق Build `19`: `flutter analyze` نظيف و`53` اختباراً ناجحاً. iOS run [33282748179](https://github.com/m7madv/otlobli/actions/runs/33282748179) وIPA `damanak_flutter/output/github-run-33282748179/ضمانك.ipa`، `23,302,381` بايت، SHA-256 `021BFA8A9021929EAE8DE1B06575F947BCF2BFBA307D2711F39CEBB1D23543AA`. Android run [33282749664](https://github.com/m7madv/otlobli/actions/runs/33282749664) نشر داخلياً، وAAB `damanak_flutter/output/github-run-33282749664/app/outputs/bundle/release/app-release.aab`، `56,313,152` بايت، SHA-256 `65729812ECD659290BEB14412DA8E9802660BF2C5BFC3D856091BE88CA594C4F`.
