...
LATEST MANUAL REQUEST (2026-09-20): improve promotion/indexing only; owner explicitly excludes the published app. Ten bilingual marketing pages now deployed to the EXISTING `voicebrief-legal` project, READY `dpl_8hA7WeQTiv8dymwq28N4sXE81oBu`, alias https://voicebrief-legal.vercel.app . Added en/ar Arabic-transcription and calendar-review guides, crawlable crosslinks and breadcrumb/article structured data. A search sample found legal-page results, so their brand links now reach the localized product homepage. Legal content, forms and submit handlers remain unchanged. App identity last independently verified19Sep: app6805194629, VoiceBrief: Audio Summaries, mohammad alzouabi,0.1.2,11UI languages. No native app/backend/subscription/store/emulator modifications. Exact artifact hash/rollback in `voicebrief_flutter/docs/MARKETING_DISCOVERY.md`.
...
IndexNow newest batch at2026-09-19T23:01:54.4509255Z (20Sep local) returned200 for14new/modified pages (10marketing+4legal), superseding the earlier202receipt for6pages. This means successful submission, NOT confirmed indexing/ranking. Same public ownership key; no spam retries/new automation. Google Search Console verification and Product Hunt/AlternativeTo submissions remain account-gated. AppAgg `/add/?hl=en` hit Cloudflare human verification before form access: STOP there, no bypass/alternative stealth automation. No external directory listing/post has been published. SaaSHub rejects free subdomains; no domain purchase authorized. Future promotion must remain maker-disclosed and truthful, no fake votes/reviews/downloads or guaranteed AI recommendations. Previous emulator blockers below still apply if resumed.
