...
- ألغى المالك فرنسا لهذا الإصدار. App Store Connect يعرض `174` بلدًا/منطقة وفرنسا `Not Available` مع إبقاء البلدان المستقبلية تلقائيًا؛ قد يستغرق انعكاس التوافر على المتجر حتى 24 ساعة. أُرسلت العناصر الأربعة إلى App Review: iOS ‏`0.1.0 (18)`، ومجموعة `VoiceBrief Pro`، والاشتراك الشهري والسنوي. الحالة `Waiting for Review`، ووقت الإرسال المعروض `Today at 9:10 AM`، ومعرّف الإرسال `39106dc0-59f4-4c77-9d1f-96ab11a3bb0b`، ورابط التفاصيل `https://appstoreconnect.apple.com/apps/6805194629/distribution/reviewsubmissions/details/39106dc0-59f4-4c77-9d1f-96ab11a3bb0b`. النشر التلقائي بعد الموافقة مفعّل؛ راقب رسائل Apple ولا تسحب الإرسال أو تغيّره دون طلب المالك.
