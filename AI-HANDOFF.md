...
- تحقق build 19 ناجح: 80 ملف format بلا تغيير، analyze نظيف، 55 non-golden، 12 golden، 95 Deno، 5 Node، Edge fmt/lint/check، `git diff --check`، وAPK debug. AAB الموقّع حجمه `59,192,552` وبصمته `6999644E2D065EED9D74CBB0DD901480E0EC9CD2C3AA76457E7DC773781C7183`؛ وAPK حجمه `69,446,598` وبصمته `038BFAD20D043CEA87D034F50864CF3666647AADB9B0E1BE7CA2880BC80BA4BE`; code 19/target 36/APK v2 وشهادة الرفع صحيحة.
...
- Apple ما زال على build 18 بحالة `Waiting for Review`؛ بعد نجاح push/TestFlight وانتقال build 19 إلى `VALID`، وقبل أي Submit نهائي، استبدل build 18 وصحح ملاحظة السنوي إلى 300 دقيقة كل شهر. Google build 19 لم يُرفع، وسر `VOICEBRIEF_AAB_SIGNED_URL` غير موجود؛ يلزم ربطه بالحزمة النهائية قبل workflow أو استخدام الناشر المحلي المملوك للمستخدم بعد Backend.
