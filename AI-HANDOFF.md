...
- workflow القراءة فقط `.github/workflows/voicebrief-appstore-status.yml` نجح في run `33281439004`: App Store Connect يعرض `0.1.0 (9)` بحالة `VALID` وغير منتهٍ، build ID نفسه `d3788d62-0ca7-423f-b234-425a325012f7`، والحد الأدنى iOS 14. تقرير artifact رقم `9723099055` وبصمته `EB01A2277A1648A622DD5C05EEA0F6DDF5D063DF850035DAFF51927ADF0479CF`.
