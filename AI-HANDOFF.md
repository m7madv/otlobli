...
- التحقق المحلي الحالي: format على 70 ملفاً، analyze بلا مشكلات، 30 non-golden، 11 golden، Deno fmt، خمسة date tests، وDeno check. Android debug build السابق للمرشح ناجح ولم يتأثر بتعديل الخادم. CI run `33031413075` نجح بالكامل.
- TestFlight run `33031418401` نجح ورفع build 9؛ Delivery UUID `d3788d62-0ca7-423f-b234-425a325012f7`. IPA SHA-256 `10514A4DEB7D40C1CE923A2556FBAF7F439B289DFEAD00347CA59C2E8545EBCA`، وZIP SHA-256 `DF4BFA9674C7F86C88BFBF0446B0BD1DBCC88941195D5E6AAD0F69FF937AC333`. معالجة App Store Connect ما زالت غير متحققة لعدم تسجيل الدخول.
- بقي قبول WhatsApp Share Extension على iPhone حقيقي. لا تدّع أن `NSExtensionContext.open` يفتح التطبيق دائماً. سجّل أيضاً أن iOS 14 مقبول الآن، لكن تحذير Apple يطلب iOS 15 للرفع بدءاً من ربيع 2027.
