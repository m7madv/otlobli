...
الأحدث:34040072308 أكد32 VALID ومعرّفه7848f16a-97f9-4315-93bd-daea14024fc2 ومضافاً لمجموعة Damanak Internal القائمة. إضافة en-GB قيد الرفع لتوافق لغة متجر الخليج الافتراضية الموثقة من Apple؛ هذه11 محلية متجر و10 لغات تطبيق، بلا تعديل runtime أو حاجة لBuild33. بقي ربط المسودة/المراجعة العامة وفحص Sandbox.
...
مسودة Apple4.6.0 موجودة af5f3581-d237-476d-b8c4-a42c73f7cc19، أوصاف10 لغات و100 صورة COMPLETE وبصماتها متطابقة. لا تعِد رفع المكتمل. run34039342937 نجح مع UPLOAD SUCCEEDED؛ IPA24965730 بايت وبصمتهE4728DFE2289CEC91FD9449AB057A514593F682BE1815B543F2F2DEF6CBBA1A7. الفحص الفوري34039915098 ما يزال يرى31 كأحدث بناء؛ تحقق لاحقاً من32 VALID وإتاحته لمجموعة Damanak Internal ذات access-all-builds. لا تعِد رفع32 دون دليل فشل المعالجة. المنشور4.5.0 لم يتغير، ولم يُربط البناء بالمسودة أو يُرسل طلب مراجعة جديد. حساب Supabase الحالي لا يرى مشروع ضمانك، وطُلب دخول المالك لفحص صلاحية Sandbox قبل المراجعة العامة.
