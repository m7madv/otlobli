...
- App Store Connect محفوظ حاليًا كمسودة فقط. إعداد الإصدار `0.1.0 (18)` وصور iPhone/iPad وملاحظات المراجعة مكتملة؛ التطبيق مجاني ومتوافر في `175` بلدًا/منطقة، وتقييمه العالمي `4+`. مسودة Review Submission تحتوي مجموعة `VoiceBrief Pro` والاشتراك الشهري والسنوي، وكلا المنتجين في المستوى `1` وبحالة Ready for Review. إصدار التطبيق لم يُضف إلى المسودة، ولم يُضغط Submit for Review.
...
- حقوق النشر `2026 MOHAMMAD ALZOUABI` وContent Rights محفوظان. بيانات App Review المعدّة هي `MOHAMMAD ALZOUABI` وحساب Google للمراجع `mhm1981d@gmail.com` والهاتف `+974 70067040`؛ ما زالت كلمة مرور الحساب وحفظ النموذج مطلوبين، ولا تُقرأ أو تُطبع كلمة المرور. أبقى المالك فرنسا، واختير التشفير المعياري غير الخاص في استبيان Apple، فظهر طلب `French encryption declaration approval form`. البناء 18 يعلن `ITSAppUsesNonExemptEncryption=false`؛ يلزم اعتماد ANSSI، رفعه إلى Apple، انتظار رمز الامتثال، وإنشاء بناء جديد بالقيم الصحيحة قبل ربط إصدار iOS. المسودة ما زالت `3` عناصر ولا تحتوي إصدار iOS.
