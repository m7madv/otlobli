...
build `7` رُفع إلى App Store Connect بنجاح عبر GitHub run `32783227070` بعد التحقق من التوقيع وملف التوزيع واستحقاق `Sign in with Apple`. لا يعتبر الرفع بديلاً عن شراء Sandbox واستعادة وتجديد فعلي على iPhone.
