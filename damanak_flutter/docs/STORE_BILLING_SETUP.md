...
- ثبت Build `26` وشراء Apple حقيقي على iPhone من TestFlight. حذف المستخدم حساب ضمانك بعد نجاح الشراء مباشرةً، فبقي الاشتراك لدى Apple وصارت استعادته orphan. بين `08:36:15` و`08:38:40` بتوقيت الرياض وصلت سبع محاولات v27 للمتجر نفسه؛ أعاد الفاحصان الرسميان الحالة `1` ثم رفض فاحص التوافق بسبب عدم توافق X509 مع Deno `2.1.4`، بلا كتابة أو رد `200`. محاولة شراء جديدة لم تُنشئ معاملة لأن الاشتراك مملوك؛ نُشرت v28، لكن الاستعادة بعدها ما تزال بانتظار محاولة حقيقية واحدة ولم يُثبت شراء أو استعادة Android.
...
10. الحالة التي أبلغ عنها المستخدم بعد v28: اشتراك Sandbox على حساب ضمانك محذوف، ثم حساب/متجر نهائي واحد، والضغط مرة واحدة على «استعادة المشتريات»؛ يجب أن يعيد التحقق HTTP `200`، ويظهر الاستحقاق للمتجر الوحيد، ثم تصبح «توسع» قابلة للترقية من دون دفع مكرر. لا تشترِ مرة أخرى لإجراء هذا الاختبار.
