...
- [x] migrations حتى `20260901011000` منشورة على `exxayzlklvgeyqhvtzgi`، واختبارات SQL الحية الأربعة نجحت داخل `BEGIN/ROLLBACK`.
...
- [ ] تثبيت Build `25` من TestFlight على iPhone حقيقي وتوثيق الجهاز والحساب والنتيجة.
