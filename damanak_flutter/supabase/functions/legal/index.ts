  ...
  privacy: {
    ...
    body: `
      ...
      <section>
        ...
        <p>لا نبيع البيانات الشخصية. يمكن لعضو المتجر إنشاء رابط موقّع لبطاقة ضمان ومشاركته مع العميل؛ تعرض الصفحة بيانات محدودة وتخفي الاسم الكامل والهاتف والرقم التسلسلي. يستطيع كل من يملك الرابط فتحه، لذلك يجب عدم نشره علناً. تستضيف Supabase بيانات الخدمة حالياً في منطقة Mumbai في الهند، وقد تعالج Apple وGoogle البيانات اللازمة لتسجيل الدخول والدفع وفق سياساتهم. نحتفظ بالبيانات ما دام الحساب قائمًا أو بالقدر اللازم للالتزامات النظامية وتسوية النزاعات.</p>
      </section>
      <section>
        <h2>حقوق المستخدم</h2>
        <p>يمكن طلب الوصول أو التصحيح أو الحذف من خلال المتجر المسؤول عن السجل، ويمكن حذف حساب عضو التطبيق من داخله. حذف الحساب لا يلغي تلقائيًا اشتراك المتجر؛ يجب إدارة الاشتراك من App Store أو Google Play. للاستفسار راسل <a href="mailto:${supportEmail}">${supportEmail}</a>.</p>
      </section>`,
  },
  terms: {
