...
--
-- Migration 20260901200000: free access and billing repair.
-- Appended because this checked-in bootstrap schema extends the latest
-- portable pg_dump snapshot with subsequently deployed migrations.
--
