...
- اكتملت بيانات App Store لإصدار `4.5.0` والتوفر في دول الخليج الست والاتفاقيات البنكية والضريبية. الاشتراكات الستة كلها `Ready for Review`. جُهزت خمس صور iPhone `1284×2778` وخمس صور iPad `2048×2732`، وأُصلحت عيوب العربية والدعوة والقص. رُبط رفعها آلياً بإجراء `Damanak Apple Setup` الموجود؛ بقي تشغيله ورفع Build `23` وربطهما ثم إرسال مسودة الإصدار والاشتراكات.
