...
- الإصدار المصدر الحالي `0.1.0+10`. نجح محلياً format وanalyze و30 اختباراً و11 golden وAPK debug؛ بصمة APK هي `3C9B96B65281D140CAF3FEA05DAEBFB6CD636A7E78BD1ABB5803E7A548F97C15`. بناء Xcode الموقع ورفع TestFlight ما زالا قيد المتابعة.
- أكد فحص App Store Connect الآمن في run `33281554578` أن البناء `0.1.0 (9)` حالته `VALID` وغير منتهٍ ومرتبط بمجموعة `VoiceBrief Internal`، وأن معرّفه يطابق Delivery UUID. تقرير الفحص artifact رقم `9723131680` وبصمة SHA-256 `15DF660E61DAA9F05FC42A3696CB071A4F7FEF5ED772892131A8717C0EB71C1F`.
...
- بعد وصول البناء 10 يجب اختيار VoiceBrief من خيار فتح ملف التسجيل في قائمة المشاركة والتحقق أنه ينتقل إلى التطبيق ويستورد الملف. لا يوجد ادعاء قبول جهاز حتى الآن.
