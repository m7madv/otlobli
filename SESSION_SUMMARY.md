...
- النظام السحابي لم يُفعّل بعد لأن إنشاء مشروع `Supabase` مستقل يحتاج اختيار المشروع ووضع مفاتيحه. لم يُختبر على هاتف حقيقي، ونسخة iPhone الجديدة تنتظر بناء GitHub ثم توقيع Apple.
