...
- نجح محلياً format وanalyze و42 اختباراً وظيفياً و12 بصرياً و16 اختبار Deno وبناء Android debug. APK حجمه `177,653,885` بايت وبصمته `DF67F60678B42A38A0FAC415FC79ECA224F3BDA772123726C153D1FA0C6AE64E`.
- build 17 لم يُرفع إلى TestFlight بعد لأن تغييرات الحماية تعتمد على migration ودالة رفع جديدة في Supabase. جلسة الحساب المفتوحة ترى Damanak فقط؛ لم يُنشر إليها شيء. المطلوب دخول الحساب الذي يملك `jyehqpdbayslhzebdycj` ثم النشر إليه حصراً، وبعد نجاح CI يُرفع TestFlight للمجموعة الداخلية فقط. النشر العام إلى Apple/Google مؤجل حتى قبول المستخدم.
