...
- أصبح إصدار Apple `4.5.0` منشوراً بحالة `READY_FOR_SALE` ولا توجد مسودة مراجعة نشطة، بينما بقي Google Alpha على Build `23`. رفضت Apple محاولة `4.5.0 (29)` فقط لأن قطار الإصدار أُغلق، لذلك نُقل Build `29` إلى `4.5.1` لإعادة رفعه إلى TestFlight. لم يُثبت أو يُقبل بعد على جهاز حقيقي أو عبر VoiceOver/TalkBack أو جهاز Android ضعيف.
