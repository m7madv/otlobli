...
## ضمانك 4.3.0+18 — إصلاح كتالوج الاشتراكات (2026-08-27)

- أصبحت المهمة الأساسية في الواجهة هي إصدار الضمان والبحث عنه ومشاركته ومتابعته، مع شاشة اشتراك أبسط توصي بخطة نمو وتعرض فقط المزايا المتاحة فعلياً.
- حُدثت الحصص إلى `100/600/3000` ضمان شهرياً لباقات بداية/نمو/توسع، مع بقاء الأسعار والعملات من Apple وGoogle من دون تغيير معرّفات المنتجات. الضمانات السابقة تبقى للعرض والمتابعة بعد انتهاء الاشتراك.
- عولج عطل Build `17` الذي كان ينتهي بـ`storekit_no_response`: Build `18` يجمع الردود الجزئية، يضبط مهلة كلية، ثم يجرب StoreKit 2 وStoreKit 1 ودفعات أصغر من دون تعليق شاشة الاشتراك.
- نُقلت أداة Apple إلى نموذج بيانات الاشتراك المعتمد على الإصدارات `4.4.1`، وصُحح التوفر إلى `UPFRONT` في دول الخليج الست. الفحص [33074176969](https://github.com/m7madv/otlobli/actions/runs/33074176969) يؤكد Build `18` بحالة `VALID` داخل `Damanak Internal`، والبيانات والتوفر والأسعار القطرية `6/6`. لم تُرسل مراجعة عامة؛ محاولة ربط المسودة أضافت `0` منتجات.
- نجح `flutter analyze` و`52` اختباراً و`6/6` لقطات، ونجح بناء Flutter Web وAndroid debug. رفع [33071848783](https://github.com/m7madv/otlobli/actions/runs/33071848783) IPA Build `18` إلى TestFlight، ونشر [33071309057](https://github.com/m7madv/otlobli/actions/runs/33071309057) AAB Build `18` إلى اختبار Google Play الداخلي.
- IPA حجمها `23,303,261` وبصمتها `E697D870320F768458DF626C06F3EB6545A4488D6D1CD851B13CB7D5C0AED4E8`. AAB حجمها `56,313,036` وبصمتها `8FDC30EE19EE850649171E90A619BF40ACEC2D9E028B32D296A48D71607A7E08`.
- المتبقي هو قبول الجهاز: تحديث iPhone إلى Build `18` وفحص المنتجات `6/6` والاستعادة. لم يُنفذ شراء حقيقي. Note 8 ما يزال على Play Build `16`، وإعادة أسعار Google الحديثة ما تزال محجوبة بصلاحية حساب الخدمة.
