...
- الإصدار المصدر الحالي `0.1.0+14`: على iOS 26 فما بعد يطلب إذن Apple الخاص بالمنبّهات والمؤقتات ويجدول منبّهًا نظاميًا فعليًا عبر `AlarmKit`؛ على iOS 14–25 يبقى إشعار محلي كحل احتياطي، وعلى Android يبقى منبّه النظام. عبارة مثل «الساعة الخامسة» تفتح تأكيد التاريخ والوقت أولاً.
