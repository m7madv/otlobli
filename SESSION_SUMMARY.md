# ملخّص جلسة v86.72 — أولوية أيقونة لون SHEIN (2026-08-08)

تم إصلاح المنتجات التي تعرض ألواناً كأيقونات بينما الاسم واحد مثل «متعدد الألوان». الآن نحدد صف الألوان كاملاً، ونأخذ صورة الأيقونة المختارة نفسها، ولا نسمح لصورة خلفية المنتج العامة أن تستبدلها. عند الضغط على أيقونة بلا اسم مميز تحفظ صورتها أيضاً. كذلك لا يظهر صف المقاسات المركّب مثل `SMLXL` كأنه مقاس؛ تظهر المقاسات القابلة للاختيار فقط (`S` و`M` و`L` و`XL`). أما «المزيد من الخيارات» الوصفية فلا نحولها إلى خيارات شراء وهمية.

نسخة أندرويد: `86.72 / 932`، بُنيت وثُبّتت على النوت 8. ملف التحميل: `C:\Users\MOHAMMAD\OneDrive\Desktop\otlobli-android-v86.72\otlobli-v86.72-note8-debug.apk`، الحجم `11,122,238` بايت، SHA-256: `94C182583A75BB30C11614E4F38E251177141D683B14AC7634FD44C3B68C1F66`.

التحقق: حارس تجمد الآيفون، بناء الويب، حد الأداء، مزامنة Android/iOS وAndroid `assembleDebug` نجحوا. لم نلمس أي من منطق تجمّد الآيفون أو تبديل المناطق. يلزم فقط تجربة إضافة المنتج الحي ذي الأيقونات إلى السلة على أندرويد وآيفون؛ لم يُطلب IPA جديد لهذه الدفعة.
