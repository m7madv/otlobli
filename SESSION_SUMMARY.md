...
## v86.41 — منع خلط درج الشحن وإعادة فتح خيارات المنتج

- اللون والمقاس في v86.40 صارا صحيحين بتأكيد المستخدم ولم يتغير التقاطهما أو السعر. الخلل الجديد كان أن الضغط على الإضافة ودرج الشحن مفتوح قد يمر إلى قراءة المنتج ويخلط عناصر ظاهرة لا تخصه.
- صار وجود جذر شحن حقيقي مرسوم حاجزاً نهائياً: تُمسح ذاكرة الخيارات المحتمل تلوثها، تظهر رسالة لإغلاق قائمة الشحن، ولا تُفتح خيارات المنتج ولا تُرسل إضافة.
- سبب عدم فتح «انقر للشراء» كان أن SHEIN تبقي نافذة الخيارات المغلقة خارج الشاشة وبأبعاد موجبة؛ الكود حسبها مفتوحة. الآن لا تُقبل مجموعات الخيارات إلا داخل الشاشة، ويُضغط صف `لون / مقاس` الكامل لأن حدث SHEIN قد يكون مربوطاً بالصف لا بالنص الداخلي.
- الاختبار المطابق أثبت: درج الشحن `فتح=0/إضافة=false`، بعد إغلاقه تفتح الخيارات مرة، وبعد نقلها خارج الشاشة تُفتح ثانية، ثم تصل السلة بـ`صينية من الخشب الصلب + بيج / كبير + $14.66`. اختبارات المقاس السابقة بقيت سليمة.
- نجح حارس التجمّد والبناء وميزانية الأداء ومزامنة Android/iOS وGradle. APK: `C:\Users\MOHAMMAD\OneDrive\Desktop\otlobli-v86.41-shein-shipping-add-guard-drawer-reopen-debug.apk`، SHA-256 `B973FEB36D1E9B93FBF27DAE42D8CA19DC3E1CEFDBAE0DD3E10E75916766583F`.
- نجح GitHub/Xcode run `30698158082` من commit `760d62f`. IPA غير الموقّعة: `C:\Users\MOHAMMAD\OneDrive\Desktop\otlobli-v86.41-iphone16-unsigned.ipa`، SHA-256 `1DEE3626DF5CFA575310FE8877975EE39A6BEC8AB805228031884F9143D75379`. الفحص أكد `86.41/901` وحراس الشحن والخيارات والتجمّد، وعدم وجود توقيع للتطبيق أو provisioning profile.
- v86.41 ما زالت تحتاج قبول iPhone الحقيقي للتسلسل نفسه. مشكلة قلب منطقة SHEIN التلقائي منفصلة وما زالت مفتوحة.
