...
- الإصدار `0.1.0+9`. نجح CI run `33031413075` بالكامل، ونجح TestFlight run `33031418401` في التوقيع والتحقق والرفع. بصمة IPA هي `10514A4DEB7D40C1CE923A2556FBAF7F439B289DFEAD00347CA59C2E8545EBCA`؛ معالجة Apple داخل App Store Connect لم تُتحقق بعد.
