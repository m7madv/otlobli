# ملخّص جلسة v86.70 — أربع دول فقط لكل متجر (2026-08-08)

Update — لكل من SHEIN وTemu الآن أربع دول فقط في لوحة الإدارة: الأردن، الإمارات، قطر، السعودية. كل متجر يبقى مستقلاً، لكن لا تظهر ولا تُحفظ دولة من خارج هذه الأربع. الأردن صار جزءاً فعلياً من مسار SHEIN التلقائي، والخادم يرفض إعداد منطقة ناقصاً أو غريباً. نسخة التطبيق 86.70 / 930 نجحت في البناء والمزامنة؛ النشر وملف iPhone الجديد جاهزان، وتجارب الأردن والإمارات وقطر الحقيقية ما زالت مطلوبة.
Artifact — تم نشر حماية الخادم ولوحة الإدارة الرسمية، وبناء iPhone 86.70 نجح في run 31263455465. الملف: C:\Users\MOHAMMAD\OneDrive\Desktop\otlobli-ios-v86.70\otlobli-v86.70-iphone16-unsigned.ipa وبصمته SHA-256: 32BC2AABF2E8005CCFFFA275E69C2A56C4C8B9CEC5B7299BF111A7F72315C6F1.
