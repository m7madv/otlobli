...
- لم يُرسل التطبيق إلى Apple حتى الآن. بقيت بيانات قانونية لا يجوز تخمينها: اسم صاحب الحقوق، جهة اتصال المراجعة، حساب المراجعة وكلمة مرور يدخلها المالك مباشرة، إقرار Content Rights، وقرار امتثال فرنسا؛ Flutter/Dart يضم TLS معياريًا عبر BoringSSL، ولذلك قد يتطلب إبقاء فرنسا تصريح تشفير ورمز امتثال وإعادة بناء. إصدار التطبيق نفسه لم يُضف بعد إلى مسودة المنتجات الثلاثة.
