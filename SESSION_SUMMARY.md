...
- Committed v85.8.17 as `dcb0539`; iOS run `29442903610` succeeded and produced `C:\Users\MOHAMMAD\Desktop\otlobli-v85.8.17.ipa` with SHA-256 `0CF2E8ED4871FC1BC0CF327606D670E6BF7CDAB55C52F0A30875EAEC968E42B3`. The embedded version marker was verified; real-device acceptance remains pending.
- The next local v85.8.18 candidate treats the pictured SHEIN consent sheet as a blocking pre-paint state: fresh documents are gated, exact Accept-all is clicked in the owning frame, child frames handshake with the top gate, and only bounded new-node inspection is used. No permanent timer, Temu, or business-logic change was added; IPA pending.
