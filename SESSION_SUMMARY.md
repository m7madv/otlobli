...
- رُفع المشروع إلى GitHub على `codex/voicebrief-ios`. التشغيل النهائي `32788817963` أخضر بالكامل: Android والتحليل و25 اختباراً، 8 golden على Windows، وبناء iOS release بلا توقيع على macOS مع التحقق من Share Extension وتغليف IPA. الملف المحلي `voicebrief_flutter/output/github-run-32788817963/voicebrief-ios-unsigned-3/VoiceBrief-0.1.0-build1-unsigned.ipa`، حجمه `16,807,014` وبصمته `79064717F6E26FC6DAA9D3CE30BEADB302AA581C82F618C7C2239E45D1AD900C`. لا يحتوي provisioning ولا يمكن تثبيته بالطريقة العادية؛ ما زال يحتاج Apple signing وتجربة Share Extension والقص على iPhone حقيقي. RevenueCat/منتجات المتاجر وOAuth العام ما تزال خارجية.
