...
## ضمانك — متجر بلا حصة مجانية وتجهيز Build 25 لـTestFlight (2026-09-01)

- بقي Build `23` داخل App Review وGoogle Alpha، وبقي Build `24` في TestFlight فقط. رُفع رقم المصدر إلى `4.5.0+25` لنسخة iPhone جديدة؛ لم يُرفع Build `25` بعد إلى Apple أو Google عند هذه النقطة.
