...
## ضمانك — تدقيق الاشتراك الكامل ومصدر 4.5.0+24 (2026-08-31)

- بقي Build `23` المرسل إلى Apple وGoogle من دون تغيير. المصدر الحالي Build `24` راجع الكتالوج والشراء والاستعادة والترقية والخفض وتغيير الدورة والإلغاء والمصالحة وحذف الحساب، ولا يجوز الادعاء بأن رقع Flutter الجديدة موجودة في الحزمة قيد المراجعة.
