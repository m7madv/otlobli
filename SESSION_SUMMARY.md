...
## إضافة اللغات وصور المتجر

- جُهز الإصدار 0.1.2 (21) بإحدى عشرة لغة إجمالًا: العربية ومعها عشر لغات واسعة الاستخدام. يمكن اتباع لغة الجهاز أو اختيار اللغة من الإعدادات، ويُحفظ الاختيار بعد إغلاق التطبيق.
- أُعدت أربع صور متجر لكل لغة على iPhone وiPad، بإجمالي 88 صورة ومحتوى توضيحي من واجهات التطبيق الحقيقية. الصور لا تضيف ميزات غير موجودة؛ مساراتها وبصماتها في `voicebrief_flutter/store_assets/localized/manifest.json`.
- نجحت اختبارات اللغات وتوليد الصور. التحقق النهائي للبناء ونشر تعديل الخادم وربط الصور بمسودة أبل قيد التنفيذ؛ التحديث لم ينشر ولم يرسل للمراجعة. أبل تختار لغة المتجر بحسب اللغات المدعومة وإعدادات المستخدم ومنطقته، وليس وفق إعداد اللغة داخل VoiceBrief وحده.
- نُشر تعديل الخادم بنجاح، واكتمل70 اختبارًا و12 اختبار صور وبناء أندرويد محلي. عولج خلل صغير في احتواء اسم التطبيق مع النص العربي المكبّر كشفه فحص Linux السحابي.
- أبل تؤكد أن0.1.1 منشور. أُنشئت مسودة0.1.2 ورفعت إليها الصور العربية الثماني؛ إضافة الإنجليزية تحتاج اسم متجر مميزًا لأن VoiceBrief محجوز هناك لحساب آخر. أُرسل سؤال للمالك لاعتماد اسم وصفي، ولم تُمس صور النسخة العامة أو يُرسل التحديث للمراجعة.
- نجح تجميع آيفون، وحُدث فحص التغليف ليتحقق من البناء21 بدل20 ومن وجود جميع الترجمات داخل التطبيق ونافذة المشاركة. التحقق السحابي النهائي جارٍ؛ لا رفع موقّع أو تقديم مراجعة جديد.
- اكتمل تحقق آيفون وتغليفه، وصُححت قابلية عرض زر الاشتراك على شاشات ضيقة ونصوص مكبّرة. نجحت فحوص جميع اللغات على صفحات الدخول والبداية والإعدادات والنتيجة والاشتراك والمنبهات والسجل، و12 اختبار صور. اعتماد الاسم الوصفي للمتجر ما زال معلقًا لدى المالك.
