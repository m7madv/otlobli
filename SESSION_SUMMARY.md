...
- الإصدار المصدر الحالي `0.1.0+13`. نجح محلياً format على 73 ملفاً وanalyze و34 اختباراً غير golden و11 golden و7 اختبارات Deno مع check. APK debug حجمه `177,609,821` بايت وبصمته `86EA9BF33CA6FC39C337A83EBE7879781EE21AE1080AC74CEBFAFDF85DA4ECE7`. رفع TestFlight للبناء 13 ما زال قيد التنفيذ عند كتابة هذه الحالة.
