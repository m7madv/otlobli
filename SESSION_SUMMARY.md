...
- جُهزت صفحة Apple للبناء `0.1.0 (18)` عمليًا: تقييم `4+`، تطبيق مجاني، `175` بلدًا/منطقة، أربع صور iPhone وأربع صور iPad، وملاحظات مراجعة عربية تشرح تسجيل Apple والتسجيل الصوتي والمشاركة من WhatsApp والمواعيد والمنبهات والاشتراك. جُمعت مجموعة `VoiceBrief Pro` والاشتراكان الشهري والسنوي في مسودة مراجعة واحدة، ووُضعا في المستوى نفسه لأن المزايا متساوية.
...
- حُفظت حقوق النشر باسم `2026 MOHAMMAD ALZOUABI`، وحُفظ إقرار أن المالك يملك حقوق محتوى الطرف الثالث. جُهزت بيانات المراجع باسم `MOHAMMAD ALZOUABI` وحساب Google `mhm1981d@gmail.com` والهاتف `+974 70067040`، لكنها ما زالت تحتاج كلمة مرور الحساب وحفظ النموذج. اختير إبقاء فرنسا، وطلب Apple `French encryption declaration approval form` لأن البناء يضم TLS معياريًا عبر BoringSSL؛ يلزم اعتماد ANSSI ورمز امتثال وبناء جديد. مسودة المراجعة ما زالت `3` عناصر، ولم يُضف إصدار iOS أو يُرسل التطبيق للمراجعة.
