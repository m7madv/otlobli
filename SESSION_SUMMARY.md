...
- طُلب من المالك اعتماد اسم المتجر الإنجليزي `VoiceBrief: Audio Summaries` ووصف مترجم عند الحاجة. لم يرد جواب بعد، ولم يغيّر الاسم أو يرسل التحديث للمراجعة أو يرفع بناء21 إلىTestFlight. يظهر المحتوى المترجم للعملاء بعد إكمال المسودة وإصدار التحديث، وفق اختيار أبل للغة الجهاز والمتجر.
