...
- بقي iOS غير مبني على Windows، رغم إضافة مصدر القص الحقيقي بـ`AVAssetExportSession`. يحتاج Xcode وتوقيعاً واختبار Share Extension والقص على iPhone حقيقي. إعدادات RevenueCat/منتجات المتاجر وApple signing ما تزال خارجية، وOAuth Google ما يزال Testing.

## ضمانك 4.1.0+7 — دخول المتاجر ودعوة الموظف (2026-08-24)
...
- أُنشئ تطبيق Google Play الفعلي وفعّلت Android Publisher API وحساب خدمة مخصصاً للتحقق. رُفع الإصدار `4.1.0 (7)` ونُشر لمسار الاختبار الداخلي؛ رابط الانضمام `https://play.google.com/apps/internaltest/4701722430109624070`، وبقي حفظ قائمة بريد المختبر وحذف مفتاح حساب الخدمة الأول المفقود بعد تأكيد المستخدم.
