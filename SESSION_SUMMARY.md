...
- مصدر iPhone متزامن محلياً، لكن بناء GitHub/Xcode واختبار iPhone الحقيقي ما زالا معلّقين في هذه اللحظة. لا يوجد ادعاء نجاح على iPhone قبل تجربة السلة والشريط وخمس دورات خلفية/رجوع وتشغيل بارد منفصل.
