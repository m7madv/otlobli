...
## ضمانك 3.0.0 — نظام البيع والضمان الكامل (2026-08-24)

- اكتمل `damanak_flutter/` كنظام مستقل للحسابات والمتاجر والموظفين والصلاحيات والاشتراكات والمنتجات والعملاء والفروع والباركود والفواتير والضمانات والصيانة والتقارير.
- يدعم `SAR/AED/KWD/QAR/BHD/OMR/USD/SYP`، وضريبة قابلة للتعديل وأسعاراً شاملة أو غير شاملة، وخصماً وطريقة دفع وترقيماً تلقائياً للفواتير ورقماً ضريبياً وسجلاً تجارياً.
- أضيف مخطط عمليات `Supabase` مستقل مع العملاء والفروع وحقول الفاتورة و`RLS` والتدقيق. لم يُنشر شيء إلى قاعدة فعلية أو إلى Otlobli.
- بقي التصميم وفق `Apple Design`: أخضر واحد ودرجات حيادية، مع عملاء وفروع وتقارير وإعدادات ونموذج مالي احترافي. اختُبر تدفق فاتورة بقيمة `649` وخصم `49` وضريبة `78.26` وإجمالي `600`، وراجعت الواجهات عند `320×568` و`393×852` و`1280×800` بلا أخطاء متصفح. الصور في `output/playwright/damanak-v3/`.
- نجح format و`flutter analyze` و12 اختباراً وبناء الويب وAndroid. ملف التجربة: `C:\Users\MOHAMMAD\Projects\SHEIN IN SIRYA\output\damanak\damanak-3.0.0-release-test.apk`، حجمه `73,466,821` بايت، وبصمة SHA-256 `B409CE6560E58FBED53D44DED9C215149F5FC12612AD681E3F3C04691B27D805`؛ ليس موقّعاً بمفتاح متجر إنتاج.
- رُفع الالتزام `cc12cc4` إلى `codex/damanak-flutter`، ونجح GitHub Actions `32721794574`. ملف iPhone غير الموقّع `output/damanak/github-ios-32721794574/damanak-3.0.0-ios-unsigned.ipa` حجمه `8,296,300` بايت وبصمته `3B72982E14192126DC5B632F076D5F95FC1451FFF38257EC6FB662C7FB6C2F14`؛ فحص الحزمة أكد `com.damanak.damanak` و`3.0.0/3` بلا provisioning.
- المتبقي ثلاثة أمور خارج الشيفرة: مشروع `Supabase` مستقل، توقيع Android/Apple، وقبول على أجهزة حقيقية. الدفع المباشر اختياري؛ رموز التفعيل وطلبات الاشتراك لا تحتاج بوابة دفع.
