...
- نُشر AAB البناء 18 إلى Google Play ‏`internal` فقط عبر run `33341090128`. أكد التقرير `committed:true` وأن المسار صار `completed` للبناء 18؛ artifact رقم `9740576360`، وملف التقرير بصمته `6E42CB83EBBBA56450A800647544F5D823F83A7BAB22EAB3E56A95F58D324E36`. يعرض Play Console الإصدار «متاح للمختبِرين الداخليين»، لكنه «غير نشط» لأن قائمة المختبرين غير مربوطة؛ لم يحدث نشر Production.
- رُفعت أربع صور iPhone وأربع صور iPad إلى صفحة Apple، وحُفظت بيانات Google العربية مع الأيقونة وFeature Graphic وأربع صور هاتف. بقي بريد الاتصال وIARC وTarget audience وData Safety ودخول المراجع. مجموعة `All Apps - Closed Testers` بها 12 عضوًا لكنها غير مربوطة، وعدد المنضمين الفعلي 0؛ يحتاج الوصول العام 12 منضمًا فعليًا لمدة 14 يومًا متواصلة ثم موافقة Google على Production access.
