# ملخّص الجلسة — VoiceBrief (2026-08-27)
...
- جُهز مسار تفريغ أسرع باستخدام `gpt-4o-mini-transcribe` مع تلميح لغة النظام، وحفظ ألفاظ الأرقام العربية كما نُطقت. أضيف قياس آمن لزمن كل مرحلة لتحديد موضع البطء الفعلي دون تسجيل أي محتوى.
...
- الإصدار صار `0.1.0+9`. نجح format وanalyze، و30 اختباراً وظيفياً، و11 اختباراً بصرياً، وخمسة اختبارات للتاريخ، وبناء Android debug.
- كود Supabase وتجهيز TestFlight build 9 جاهزان محلياً. نشر الخادم متوقف فقط لأن Supabase CLI الحالي على حساب آخر، مع أن جلسة المتصفح ترى مشروع VoiceBrief؛ ورفع TestFlight لم يُدّعَ بعد.
