...
- حذف الحساب صار يفشل مغلقًا محليًا حتى يحذف RevenueCat أولاً، وتُجهّل أحداث webhook المتأخرة مع بقاء منع التكرار. أضيف مسار عام ثنائي اللغة `/delete-account` لطلب حذف يدوي موثّق. migration والدوال ومفتاح RevenueCat السري غير منشورة بعد.
...
- رُفعت أربع صور iPhone وأربع صور iPad إلى صفحة Apple، وحُفظت بيانات Google العربية مع الأيقونة وFeature Graphic وأربع صور هاتف. رُبطت قائمة `All Apps - Closed Testers` ذات 12 عضوًا بمسار `Alpha` المغلق واختيرت `176` بلدًا/منطقة إضافة إلى «بقية بلدان العالم». التغييرات محفوظة وتظهر في «نظرة عامة على النشر»، لكن Alpha ما زال بلا إصدار وغير نشط، وزر إرسال التطبيق للمراجعة معطل حتى استكمال بريد الاتصال وIARC وTarget audience وData Safety ودخول المراجع. عدد المنضمين الفعلي 0 ولم تبدأ مدة 14 يومًا.
...
- اكتمل تدقيق إجابات Data Safety وIARC من الشيفرة وAPK من دون إرسالها. رابط حذف الحساب العام المعلن يعيد 404 والسياسة العامة قديمة عن build 18؛ لذلك لن يُرسل تصريح خصوصية غير مطابق. الفئة مضبوطة أصلًا على «إنتاجية»، والناقص العملي هو بريد تواصل عام يوافق عليه المالك، نشر سياسة/رابط حذف صحيحين، اعتماد الجمهور العمري، قبول IARC، وحفظ تعليمات المراجع ثم التصريحات.
