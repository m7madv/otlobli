...
## ضمانك 2.0.0 — نظام المتجر الكامل (2026-08-24)

- صار `damanak_flutter/` نظاماً مستقلاً للحسابات والمتاجر والموظفين والصلاحيات والاشتراكات والمنتجات والباركود والضمانات والصيانة، مع عرض تشغيلي محلي وتنفيذ `Supabase` جاهز للربط بمشروع مجاني مستقل.
- الماسح جزء من التطبيق نفسه: يقرأ الباركود، يطابق كتالوج المتجر، ثم يفتح إصدار الضمان. اختُبر الباركود `6281000000142` حتى وثيقة الضمان والرجوع إلى الماسح بلا خطأ كاميرا.
- أُعيد التصميم بمهارة `Apple Design`: أخضر واحد، درجات حيادية، مظهر فاتح وداكن، أهداف لمس واضحة، حالات بأيقونة ونص، واحترام تقليل الحركة. تقرير التدقيق في `docs/DESIGN_AUDIT.md`.
- نجح تحليل الكود بلا ملاحظات، ونجحت 8 اختبارات، وبناء الويب، ومراجعة بصرية فعلية عند `320×568` و`393×852` و`1280×800` في المظهرين. الصور في `output/playwright/damanak-apple/`.
- ملف Android للتجربة: `C:\Users\MOHAMMAD\Projects\SHEIN IN SIRYA\output\damanak\damanak-2.0.0-release-test.apk`، حجمه `72,563,673` بايت، وبصمة SHA-256 `97237091826F2021C7E54E8E614C94246856C7B7D7D1402C5ED8F514949F66E3`. ليس موقّعاً للنشر في المتجر.
- نجح بناء iOS في GitHub Actions ضمن التشغيل `32715444002`. ملف iPhone غير الموقّع: `C:\Users\MOHAMMAD\Projects\SHEIN IN SIRYA\output\damanak\github-ios-32715444002\damanak-2.0.0-ios-unsigned.ipa`، حجمه `8,173,743` بايت، وبصمته SHA-256 `68D976EA9727E8C0F512CB9C23421FA686CB7492871EF26EB083468F1C89E867`. فحص الحزمة أكد `com.damanak.damanak` و`2.0.0/2` وعدم وجود توقيع للتطبيق أو ملف provisioning.
- النظام السحابي لم يُفعّل بعد لأن إنشاء مشروع `Supabase` مستقل يحتاج اختيار المشروع ووضع مفاتيحه. لم يُختبر على هاتف حقيقي، ويلزم توقيع Apple لتثبيت نسخة iPhone بصورة اعتيادية.
