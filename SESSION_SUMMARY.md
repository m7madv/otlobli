...
## ضمانك 1.0.0 — تطبيق Flutter مستقل (2026-08-24)

- تم بناء مشروع `damanak_flutter/` كتطبيق عربي مستقل لإدارة الضمانات الرقمية، من دون تعديل مشروع «اطلبلي» أو الدفع أو المحفظة.
- يستطيع المتجر إدخال بياناته، إصدار بطاقة ضمان، البحث والتصفية حسب الحالة، مشاركة البطاقة، عرض `QR` لا يتضمن رقم الجوال، وتسجيل طلب صيانة وتحديث حالته.
- كل البيانات محفوظة محلياً؛ لا خادم ولا حساب ولا رسوم تشغيل. هذا يعني أيضاً عدم وجود مزامنة أو نسخة احتياطية تلقائية في الإصدار الأول.
- نجح تحليل الكود و3 اختبارات وبناء الويب، ونُفذ مسار إنشاء ضمان في متصفح حقيقي مع مراجعة `320×568` و`360×640` وسطح المكتب.
- ملف Android الأخف الجاهز للتجربة: `C:\Users\MOHAMMAD\Projects\SHEIN IN SIRYA\output\damanak\damanak-1.0.0-release-test.apk`، حجمه `52,118,405` بايت، وبصمة SHA-256: `4DEE607CFFD50D310FCD6C8E4395AA70577DEEE7BF69688A74754E7FEC86CAE0`. هو موقّع محلياً للتجربة وليس للنشر في المتجر.
- نجح بناء iPhone عبر GitHub Actions في run `32702652314`. ملف IPA غير الموقّع: `C:\Users\MOHAMMAD\Projects\SHEIN IN SIRYA\output\damanak\github-ios-32702652314\damanak-1.0.0-ios-unsigned.ipa`، حجمه `7,365,052` بايت، وبصمة SHA-256 `007FAE099D7611155C0C96AF114741E3E124DEFF80CD534D18E8190E6DC1B721`. يلزمه توقيع Apple قبل التثبيت العادي، ولم يُختبر على هاتف حقيقي.
