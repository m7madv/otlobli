...
- الإصدار `0.1.0+9`. نجح CI النهائي run `33280858741` من الالتزام `05d9c3e` بالكامل، ونجح TestFlight run `33031418401` في التوقيع والتحقق والرفع. بصمة IPA هي `10514A4DEB7D40C1CE923A2556FBAF7F439B289DFEAD00347CA59C2E8545EBCA`؛ معالجة Apple داخل App Store Connect لم تُتحقق بعد.
...
- لا يزال اختبار مشاركة تسجيل WhatsApp والانتقال المباشر على iPhone حقيقي مطلوباً؛ iOS قد يرفض طلب الفتح من الامتداد، لذلك لا يوجد ادعاء قبول جهاز حتى الآن.
