...
- بقي Build `23` في App Review وGoogle Alpha بلا تغيير. Build `27` ما يزال الأحدث في iPhone TestFlight وحالته `VALID`؛ Build `28` لم يُرفع بعد، ولم يُختبر منع الخفض على جهاز حقيقي أو عبر VoiceOver/TalkBack أو جهاز Android ضعيف.
