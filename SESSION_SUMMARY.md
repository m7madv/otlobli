...
- ألغى المالك فرنسا لهذا الإصدار؛ أصبح التطبيق مجانيًا ومتاحًا في `174` بلدًا/منطقة وفرنسا `Not Available`، مع إبقاء البلدان المستقبلية تلقائيًا. أُرسلت أربعة عناصر إلى App Review: iOS ‏`0.1.0 (18)`، ومجموعة `VoiceBrief Pro`، والاشتراك الشهري والسنوي. الحالة الحالية `Waiting for Review`، ومعرّف الإرسال `39106dc0-59f4-4c77-9d1f-96ab11a3bb0b`، والنشر التلقائي بعد الموافقة مفعّل. لم يصبح التطبيق حيًا بعد؛ تشير Apple إلى أن المراجعة قد تستغرق حتى 48 ساعة.
