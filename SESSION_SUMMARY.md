...
## ضمانك — انتقالات اشتراك ذكية في مصدر Build 27 (2026-09-01)
...
- مصدر Flutter الآن `4.5.0+27`. نجح `flutter analyze` و`186/186` اختبار Flutter و`77/77` اختبار Deno وفحص تنسيق 27 ملفاً و`git diff --check`، ونجح web release وAndroid debug. APK المحلي حجمه `207,989,448` وبصمته `33295CBE76936B806F7FA21C2FAA663C0B1294159A3DCA03A378FD7ED924DE37`. لم تُنشأ أو تُرفع حزمة iPhone/متجر لـBuild `27`.
- بقي Build `23` في App Review وGoogle Alpha بلا تغيير. رفع run [33458183412](https://github.com/m7madv/otlobli/actions/runs/33458183412) Build `4.5.0 (26)` إلى iPhone TestFlight، وصار `VALID` بالمعرّف `10a1e004-c6c1-4b56-9cff-618406c3881b` وداخل `Damanak Internal` ذات المختبر الواحد، من دون إضافته إلى App Review. IPA حجمها `23,942,352` وبصمتها `FE66B7F77FB1892FE8F3D55F0AC85AB6B0A7DF783286C77C2EDA735A82C32A37`. ثبتت الحزمة والشراء واستعادة Apple orphan على iPhone فعلياً؛ لم يُنفذ قبول بقية دورة Apple أو Android أو VoiceOver/TalkBack أو جهاز ضعيف.
