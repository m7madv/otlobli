...
- مصدر Flutter الآن `4.5.0+29`. نجح `flutter analyze` و`211/211` اختبار Flutter، واختبارات الاشتراك المركزة `69/69` بمراجعة خصومية مستقلة، و`77/77` اختبار Deno وفحص تنسيق 27 ملفاً و`git diff --check`، ونجح web release وAndroid debug. APK المحلي حجمه `208,066,330` وبصمته `08D0DDEC1E1BA1C734DA36C1F4CDCA5F2B77543D8044A8D523435E034E14A0AE`.
- بقي Build `23` في App Review وGoogle Alpha بلا تغيير. Build `28` ما يزال أحدث Build في TestFlight الداخلي وحالته `VALID`؛ Build `29` مهيأ محلياً للرفع ولم يُثبت أو يُقبل بعد على جهاز حقيقي أو عبر VoiceOver/TalkBack أو جهاز Android ضعيف.
