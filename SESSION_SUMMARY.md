...
- **لم يُبنَ APK/IPA محلياً:** هذا الـworktree بلا أدوات أصلية وبلا أسرار حقيقية، وأي `cap sync` محلي كان سينشر نسخة بأسرار وهمية. الأداة الصحيحة: تشغيل ورك فلو الفرع.
