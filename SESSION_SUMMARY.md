...
- الإصدار المصدر الحالي `0.1.0+12`. نجح محلياً format وanalyze و32 اختباراً و11 golden وAPK debug؛ بصمة APK هي `37729DAFEECC45CE66DF870AA167D4E660A7F3167C62E3352C003C3818029FE5`. ما زال تجميع Swift ورفع TestFlight للبناء 12 قيد المتابعة.
- أصبح البناء `0.1.0 (11)` متاحاً في `VoiceBrief Internal` وحالته `VALID` بحسب run `33304112131`. Delivery UUID/build ID هو `4fdd86e6-da1e-41d6-820e-48290839548a`، وبصمة IPA هي `AACAFA2BADBCA2026B1AF8080B66D0F455E79724E825BF15A8F0F352F04C577D`، وGitHub artifact رقم `9730071886`.
