# ملخّص الجلسة — VoiceBrief build 18 (2026-08-31)
...
- اكتمل إعداد IARC وData Safety من الشيفرة وAPK. Data Safety يعلن جمعًا فقط بلا مشاركة، تشفير النقل، OAuth، وحذف الحساب والبيانات عبر الصفحة الحية، مع الأنواع والأغراض الموثقة؛ تعذر الحفظ النهائي فقط لأن Google يفرض إكمال تفاصيل الدخول والجمهور أولًا. عيّن المستخدم `mhm1981d@gmail.com` لحساب المراجعة، وأُدخل البريد وتعليمات الدخول الإنجليزية في Play Console؛ كلمة المرور يجب أن يدخلها المالك داخل الحقل مباشرة، ثم يجب تسجيل الحساب مرة في build 18 ومنحه RevenueCat entitlement `pro` طويل المدة والتحقق من ظهور 300 دقيقة قبل تأكيد الوصول الكامل وحفظ البيان.
