...
- آخر TestFlight متاح حاليًا هو build 17، وحالته `VALID` في `VoiceBrief Internal`. build 18 لم يُرفع بعد. لم تُنشر تغييرات build 18 الخلفية، ولم يبدأ النشر العام إلى Apple أو Google.
- رُفعت أربع صور iPhone وأربع صور iPad إلى صفحة Apple، وجُهزت أصول Google. مجموعة Google الصحيحة `All Apps - Closed Testers` وبها 12 حساباً، لكنها غير مربوطة بعد وعدد المنضمين الفعلي 0؛ يحتاج الوصول العام 12 منضمًا فعلياً لمدة 14 يومًا متواصلة ثم موافقة Google على Production access.
