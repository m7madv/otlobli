...
- Current candidate: v85.7 / `d2f2038` / `2026.07.14-v85.7-shein-fresh-entry-health-recovery-sa-status-no-otp-test`.
...
Test v85.7 repeated entry and background/resume on iPhone 6 and iPhone 16 Pro Max without the Temu round trip. Verify taps, status text, region lock, and Saudi persistence. Do not claim success until both results are known. Add-to-Cart placement remains separate.
