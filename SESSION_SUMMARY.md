...
أصبحت نسخة أبل21 صالحة وجاهزة للإرسال، واجتازت فحص النشر كاملًا. التحذير الذي وجدناه داخلApp Store Connect رقمه90068: التطبيق يدعمiOS14 وأبل ستشترط15 في ربيع2027؛ ليس رفضًا حاليًا. جرى بدء التقديم وفق موافقة المالك. فُعّلت متابعة تلقائية كل ساعتين للمتجرين، مع تنبيه عند تغيّر مهم فقط.

## النتيجة الحالية — اللغات وصور المتجر

- ظهر أثناء التقديم نقصالكلمات المفتاحية في صفحاتاللغات الجديدة؛ أُصلح في بياناتالمتجر وأُضيف إلى الفحص الآلي بثلاثةاختبارات ناجحة. هذا منفصل عنتحذيرiOS14ولا يتطلب إعادةبناءالتطبيق. التقديم ما زال ينتظر حفظهذاالإصلاح والتحققمنه.
...
- نجح رفع0.1.2(21) الموقّع إلى أبل في34040157335. فحص ما قبل التقديم أكد مطابقة الصور والبيانات ووجود بيانات دخول المراجع وبقاء فرنسا مستثناة؛ ينتظر ظهورالبناءVALID قبل اختياره وإرساله للمراجعة، ثم النشر تلقائيًا بعد الموافقة. ليس منشورًا بعد.
