...
- جُهز فحص آلي قبل تقديم التحديث لأبل للتحقق من البناء والصور والأسماء ووجود بيانات المراجعة دون كشفها، مع حماية استثناء فرنسا. النشر بعد الموافقة سيكون تلقائيًا عند الإرسال؛ لم يحدث إرسال بعد.
- قبلت أبل اسم «VoiceBrief: Audio Summaries» للإنجليزية. يجري استكمال الصور بعد معالجة إنشاء أبل التلقائي لصفحة اللغة. بناء21 الموقّع يعمل في التشغيل34040157335 ولم يؤكد رفعه بعد.
...
- أبل تؤكد أن0.1.1 منشور. أُنشئت مسودة0.1.2 واستبدلت صورها العربية الثماني، مع بقاء صور النسخة العامة والنسخ السابقة متاحة. بقية صور اللغات جاهزة محليًا ولم ترفع بسبب تعارض اسم VoiceBrief في الإنجليزية مع حساب آخر.
