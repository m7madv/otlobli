# ملخّص جلسة v86.68 — نقر منتج الآيفون + تحديد المنطقة من الصفحة الرئيسية (2026-08-08)

- فصلنا مشكلة الآيفون بدقة: الضغط المطوّل يعمل ويظهر قائمة SHEIN الأصلية، أما النقرة القصيرة على المنتج فلا تفتح المنتج. لذلك أصلحنا مسار النقرة القصيرة فقط، من دون حجب لمس أو إعادة تحميل أو تغييرات في دورة WebView.
- أزلنا مراقب إعادة الرسم غير المجرَّب، وأضفنا احتياطاً خاصاً بالآيفون: يعطي SHEIN فرصتها أولاً، ثم يعيد النقر على بطاقة المنتج نفسها مرة واحدة فقط إذا لم يتغير المسار. السحب والضغط المطوّل لا يدخلان في هذا الاحتياط.
- أصلحنا بدء تحديد المنطقة من الصفحة الرئيسية. على النوت 8 مسحنا عنوان المنطقة فقط ثم تركنا التطبيق؛ خلال 5 ثوانٍ أعاد إنشاء عنوان السعودية الموقّع: الرياض → العليا، من دون اختيار يدوي.
- تم بناء ومزامنة Android وiOS، والنسخة صارت `86.68 / 928`. فحوصات تجمّد SHEIN والأداء نجحت. أول بناء iPhone توقّف فقط لأن بيئة Mac أكبر من الحد بكيلوبايت واحد؛ ضغطنا السكربت من دون تغيير السلوك وأعدنا الإرسال بنجاح. ملف التجربة: `C:\Users\MOHAMMAD\OneDrive\Desktop\otlobli-ios-v86.68\otlobli-v86.68-iphone16-unsigned.ipa` وبصمته `5752F54B2206F0371AD2E7BE7BC5930DCFEA588CAE825EAD2876FCEB6B09FF96`. تجربة الآيفون الفعلية ما زالت مطلوبة قبل إعلان الحل نهائياً.
