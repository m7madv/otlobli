...
- بقي Build `23` في App Review وGoogle Alpha بلا تغيير. رفع run [33458183412](https://github.com/m7madv/otlobli/actions/runs/33458183412) Build `4.5.0 (26)` إلى iPhone TestFlight، وصار `VALID` بالمعرّف `10a1e004-c6c1-4b56-9cff-618406c3881b` وداخل `Damanak Internal` ذات المختبر الواحد، من دون إضافته إلى App Review. IPA حجمها `23,942,352` وبصمتها `FE66B7F77FB1892FE8F3D55F0AC85AB6B0A7DF783286C77C2EDA735A82C32A37`. ثبتت الحزمة والشراء على iPhone فعلياً، لكن الاستعادة بعد v28 ما تزال بانتظار محاولة واحدة ورد تحقق `200` وentitlement إنتاجي؛ لم يُنفذ VoiceOver/TalkBack أو قبول جهاز ضعيف.
