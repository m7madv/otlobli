...
- الإصدار المصدر الحالي `0.1.0+11`. نجح محلياً format وanalyze و31 اختباراً و11 golden وAPK debug؛ بصمة APK هي `CF8F63D8CBC22A9AC681A2F51FAED8F7C86CB0B6DA88D6856A84B24657D84E30`. تجميع Swift ورفع TestFlight للبناء 11 قيد المتابعة.
...
- بعد وصول البناء 11: افتح VoiceBrief مرة واحدة لمزامنة الجلسة، ثم شارك التسجيل من WhatsApp واختر VoiceBrief، وأبقِ نافذة المشاركة مفتوحة حتى يظهر الملخص. لا يوجد ادعاء قبول جهاز للبناء 11 حتى الآن.
