...
- **المسار السريع:** لأن البناء `1112` معالج وموزع أصلًا، فإن اختيار
  `distribute-existing` مع App Review يفحص تفويض القبول ومرسل Otlobli الحي ثم
  يشغّل إعادة الإرسال مباشرة على Linux، ويتخطى أرشفة iOS والتوقيع ورفع
  TestFlight. لا يتجاوز هذا المسار حارس WhatsApp ولا ينشئ بناء Apple جديدًا.
