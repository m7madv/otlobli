...
- **Apple:** القراءة الحية تثبت أن `86.230 (1095)` هو المرفوض
  (`REJECTED/UNRESOLVED_ISSUES`). `86.244 (1109)` في TestFlight فقط وغير
  مربوط بإصدار عام. لا يجوز تشغيل submit العام قبل قراءة رسالة الرفض؛ سببها
  النصي غير متاح عبر API الرسمية.
