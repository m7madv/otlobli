...
- **الحالة الحية:** تنسيق الرسالة منشور على Oracle والخدمة online، لكن المرسل
  غير متصل (`whatsappConnected=false`)؛ القبول الحقيقي ينتظر إعادة الربط ثم
  تجربة iPhone وهاتف Android قديم.
