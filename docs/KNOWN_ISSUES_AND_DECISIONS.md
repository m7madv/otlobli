...
- **محاكيات الاختبار:** التحكم المقبول هو `ldconsole` وADB عبر الطرفية، مثيل
  ...
  `01 - adelalzoubi2022@gmail.com`، والمثيل مغلق وADB=0. `10` فارغ ومغلق.
  أكد المالك تسجيل `djjd19903@gmail.com` في `11`، فثُبت اسمه وأُغلق. `02`
  مفتوح على الإعدادات بانتظار حذف المالك لهذا الحساب منه والإبقاء على
  `chatxhxh@gmail.com`، ثم يعاد اسمه ويغلق. كل ADB عند الصفر. لا توقف AVD.
