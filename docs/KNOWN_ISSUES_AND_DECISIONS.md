...
- **Google Play:** التفويض محصور في AAB `86.244 (1112)` ذي البصمة
  `CCFC71D2…BBBE6`. أثبت `33308484614` أن اعتماد الخدمة صالح، لكن سجل
  `com.otlobli.app` غير موجود في Play Console، لذلك لم يبدأ رفع أو edit. سجل
  التطبيق الأولي يحتاج إقرارين قانونيين ظاهرين؛ لا يوافق AI عليهما نيابةً عن
  المالك بلا موافقة صريحة. بعد الإنشاء يمنح حساب الخدمة أقل صلاحيات القراءة
  وإصدار الاختبار، ثم يبدأ `inspect` لتحديد closed track قبل `publish`.
