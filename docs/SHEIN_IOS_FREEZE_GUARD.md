...
## حارس سعر التركيبة المحددة — v86.21
...
- البحث محدود داخل `.product-intro__head-price` و`.product-price` وبحد أقصى أربعة جذور و60 عنصراً لكل جذر أثناء إعادة محاولات الإضافة الموجودة أصلاً. ممنوع إعادة المسح العام `[class*="price"]` أو إضافة observer/polling دائم.
